# Estimation Kalman Specialist — SKILL Definition

**Agent ID:** `estimation_kalman_specialist`
**Domain:** Estimation & Kalman — KF, EKF, UKF, Particle Filter, IMM, RMSE, NEES
...
The Estimation Kalman Specialist performs estimation & kalman analysis, synthesising results
...
|---|---|---|
| Core estimation & kalman analysis (analytical) | Active (MVP) | Level 1 capability |
| Estimation & Kalman design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical estimation & kalman methods | Planned (V1) | Level 3 |
| Multi-physics estimation & kalman coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain estimation & kalman optimisation | Planned (V3) | Level 5 Master |
...
Every Estimation Kalman Specialist output MUST include:
...
6. `estimation_&_kalman_summary` — structured domain summary (see Output Contract)
...
Raise **[ESTIMATION & KALMAN SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core estimation & kalman analysis — analytical methods |
...
- **Regime violation**: applying estimation & kalman method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Estimation & Kalman Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "estimation_kalman_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for estimation & kalman
