# Requirements Traceability Specialist — SKILL Definition

**Agent ID:** `requirements_traceability_specialist`
**Domain:** Requirements & Traceability — Requirements Flow, Verification Matrix, DM, DOORS
...
The Requirements Traceability Specialist performs requirements & traceability analysis, synthesising results
...
|---|---|---|
| Core requirements & traceability analysis (analytical) | Active (MVP) | Level 1 capability |
| Requirements & Traceability design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical requirements & traceability methods | Planned (V1) | Level 3 |
| Multi-physics requirements & traceability coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain requirements & traceability optimisation | Planned (V3) | Level 5 Master |
...
Every Requirements Traceability Specialist output MUST include:
...
6. `requirements_&_traceability_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
requirements_&_traceability_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[REQUIREMENTS & TRACEABILITY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core requirements & traceability analysis — analytical methods |
...
- **Regime violation**: applying requirements & traceability method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Requirements & Traceability Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "requirements_traceability_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for requirements & traceability
