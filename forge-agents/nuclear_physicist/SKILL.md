# Nuclear Physicist — SKILL Definition

**Agent ID:** `nuclear_physicist`
**Domain:** Nuclear Physics — Fission, Fusion, Neutronics, Shielding
...
The Nuclear Physicist performs nuclear physics analysis, synthesising results
...
|---|---|---|
| Core nuclear physics analysis (analytical) | Active (MVP) | Level 1 capability |
| Nuclear Physics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical nuclear physics methods | Planned (V1) | Level 3 |
| Multi-physics nuclear physics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain nuclear physics optimisation | Planned (V3) | Level 5 Master |
...
Every Nuclear Physicist output MUST include:
...
6. `nuclear_physics_summary` — structured domain summary (see Output Contract)
...
Raise **[NUCLEAR PHYSICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core nuclear physics analysis — analytical methods |
...
- **Regime violation**: applying nuclear physics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "nuclear physics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "nuclear_physicist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for nuclear physics
