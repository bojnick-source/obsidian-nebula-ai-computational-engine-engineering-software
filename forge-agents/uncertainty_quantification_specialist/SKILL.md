# Uncertainty Quantification Specialist — SKILL Definition

**Agent ID:** `uncertainty_quantification_specialist`
**Domain:** Uncertainty Quantification — UQ, Sobol Indices, Global Sensitivity, PCE, DACE
...
The Uncertainty Quantification Specialist performs uncertainty quantification analysis, synthesising results
...
|---|---|---|
| Core uncertainty quantification analysis (analytical) | Active (MVP) | Level 1 capability |
| Uncertainty Quantification design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical uncertainty quantification methods | Planned (V1) | Level 3 |
| Multi-physics uncertainty quantification coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain uncertainty quantification optimisation | Planned (V3) | Level 5 Master |
...
Every Uncertainty Quantification Specialist output MUST include:
...
6. `uncertainty_quantification_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
uncertainty_quantification_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[UNCERTAINTY QUANTIFICATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core uncertainty quantification analysis — analytical methods |
...
- **Regime violation**: applying uncertainty quantification method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Uncertainty Quantification Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "uncertainty_quantification_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for uncertainty quantification
