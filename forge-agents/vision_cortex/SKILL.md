# Vision Cortex — SKILL Definition

**Agent ID:** `vision_cortex`
**Domain:** Vision & Perception — Image Processing, Computer Vision
...
The Vision Cortex performs vision cortex analysis, synthesising results
...
|---|---|---|
| Core vision cortex analysis (analytical) | Active (MVP) | Level 1 capability |
| Vision Cortex design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical vision cortex methods | Planned (V1) | Level 3 |
| Multi-physics vision cortex coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain vision cortex optimisation | Planned (V3) | Level 5 Master |
...
Every Vision Cortex output MUST include:
...
6. `vision_cortex_summary` — structured domain summary (see Output Contract)
...
Raise **[VISION CORTEX SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core vision cortex analysis — analytical methods |
...
- **Regime violation**: applying vision cortex method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "vision cortex Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "vision_cortex"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for vision cortex
