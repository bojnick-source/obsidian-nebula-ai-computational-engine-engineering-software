# Tester Debate A2A — SKILL Definition

**Agent ID:** `tester_debate_a2a`
**Domain:** Tester — Debate A2A — Specialist↔antagonist debate protocol, arbitration
...
The Tester Debate A2A performs tester debate a2a analysis, synthesising results
...
|---|---|---|
| Core tester debate a2a analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Debate A2A design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester debate a2a methods | Planned (V1) | Level 3 |
| Multi-physics tester debate a2a coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester debate a2a optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Debate A2A output MUST include:
...
6. `tester_debate_a2a_summary` — structured domain summary (see Output Contract)
...
Raise **[TESTER DEBATE A2A SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester debate a2a analysis — analytical methods |
...
- **Regime violation**: applying tester debate a2a method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Debate A2A Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_debate_a2a"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester debate a2a
