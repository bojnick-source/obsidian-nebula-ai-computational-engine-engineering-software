# Project Management Specialist — SKILL Definition

**Agent ID:** `project_management_specialist`
**Domain:** Project Management — Scheduling, Milestones, Risk Register, JIRA, Earned Value
...
The Project Management Specialist performs project management analysis, synthesising results
...
|---|---|---|
| Core project management analysis (analytical) | Active (MVP) | Level 1 capability |
| Project Management design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical project management methods | Planned (V1) | Level 3 |
| Multi-physics project management coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain project management optimisation | Planned (V3) | Level 5 Master |
...
Every Project Management Specialist output MUST include:
...
6. `project_management_summary` — structured domain summary (see Output Contract)
...
Raise **[PROJECT MANAGEMENT SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core project management analysis — analytical methods |
...
- **Regime violation**: applying project management method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Project Management Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "project_management_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for project management
