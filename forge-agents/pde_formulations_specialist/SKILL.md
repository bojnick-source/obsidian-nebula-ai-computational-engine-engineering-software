# Pde Formulations Specialist — SKILL Definition

**Agent ID:** `pde_formulations_specialist`
**Domain:** PDE Formulations — Discretisation, FEM/FDM/FVM, Weak Form, Stability, Convergence
...
The Pde Formulations Specialist performs pde formulations analysis, synthesising results
...
|---|---|---|
| Core pde formulations analysis (analytical) | Active (MVP) | Level 1 capability |
| Pde Formulations design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical pde formulations methods | Planned (V1) | Level 3 |
| Multi-physics pde formulations coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain pde formulations optimisation | Planned (V3) | Level 5 Master |
...
Every Pde Formulations Specialist output MUST include:
...
6. `pde_formulations_summary` — structured domain summary (see Output Contract)
...
Raise **[PDE FORMULATIONS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core pde formulations analysis — analytical methods |
...
- **Regime violation**: applying pde formulations method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "PDE Formulations Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "pde_formulations_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for pde formulations
