# Sensors Imu Gnss Specialist — SKILL Definition

**Agent ID:** `sensors_imu_gnss_specialist`
**Domain:** Sensors, IMU & GNSS — Accelerometer, Gyroscope, GPS, Magnetometer, Error Models
...
The Sensors Imu Gnss Specialist performs sensors, imu & gnss analysis, synthesising results
...
|---|---|---|
| Core sensors, imu & gnss analysis (analytical) | Active (MVP) | Level 1 capability |
| Sensors, Imu & Gnss design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical sensors, imu & gnss methods | Planned (V1) | Level 3 |
| Multi-physics sensors, imu & gnss coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain sensors, imu & gnss optimisation | Planned (V3) | Level 5 Master |
...
Every Sensors Imu Gnss Specialist output MUST include:
...
6. `sensors,_imu_&_gnss_summary` — structured domain summary (see Output Contract)
...
Raise **[SENSORS, IMU & GNSS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core sensors, imu & gnss analysis — analytical methods |
...
- **Regime violation**: applying sensors, imu & gnss method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Sensors, IMU & GNSS Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "sensors_imu_gnss_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for sensors, imu & gnss
