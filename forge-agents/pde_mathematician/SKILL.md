# Pde Mathematician — SKILL Definition

**Agent ID:** `pde_mathematician`
**Domain:** PDE Formulations — Partial Differential Equations, Weak Forms
...
The Pde Mathematician performs pde analysis analysis, synthesising results
...
|---|---|---|
| Core pde analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Pde Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical pde analysis methods | Planned (V1) | Level 3 |
| Multi-physics pde analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain pde analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Pde Mathematician output MUST include:
...
6. `pde_analysis_summary` — structured domain summary (see Output Contract)
...
Raise **[PDE ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core pde analysis analysis — analytical methods |
...
- **Regime violation**: applying pde analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "PDE analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "pde_mathematician"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for pde analysis
