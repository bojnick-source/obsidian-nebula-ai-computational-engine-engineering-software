# Forge Project Manager — SKILL Definition

**Agent ID:** `forge_project_manager`
**Domain:** FORGE Project Manager — Sprint planning, milestone tracking, resource allocation
...
The Forge Project Manager performs forge project manager analysis, synthesising results
...
|---|---|---|
| Core forge project manager analysis (analytical) | Active (MVP) | Level 1 capability |
| Forge Project Manager design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical forge project manager methods | Planned (V1) | Level 3 |
| Multi-physics forge project manager coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain forge project manager optimisation | Planned (V3) | Level 5 Master |
...
Every Forge Project Manager output MUST include:
...
6. `forge_project_manager_summary` — structured domain summary (see Output Contract)
...
Raise **[FORGE PROJECT MANAGER SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core forge project manager analysis — analytical methods |
...
- **Regime violation**: applying forge project manager method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "FORGE Project Manager Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "forge_project_manager"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for forge project manager
