# Tester Verifier Redteam — SKILL Definition

**Agent ID:** `tester_verifier_redteam`
**Domain:** Tester — Verifier Red-Team — Adversarial fixture injection, gate bypass attempts
...
The Tester Verifier Redteam performs tester verifier red-team analysis, synthesising results
...
|---|---|---|
| Core tester verifier red-team analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Verifier Red-Team design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester verifier red-team methods | Planned (V1) | Level 3 |
| Multi-physics tester verifier red-team coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester verifier red-team optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Verifier Redteam output MUST include:
...
6. `tester_verifier_red_team_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
tester_verifier_red_team_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[TESTER VERIFIER RED-TEAM SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester verifier red-team analysis — analytical methods |
...
- **Regime violation**: applying tester verifier red-team method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Verifier Red-Team Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_verifier_redteam"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester verifier red-team
