# Rover Wheel Specialist — Capability Catalogue
...
The Rover Wheel Specialist performs rover_wheel analysis at Level 1
...
|---|---|---|
| Basic rover_wheel sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Rover_Wheel design optimisation | Hard | Planned |
| Multi-physics rover_wheel coupling | Expert | Planned (Level 4) |
