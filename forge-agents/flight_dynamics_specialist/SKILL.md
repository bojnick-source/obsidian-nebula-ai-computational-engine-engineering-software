# Flight Dynamics Specialist — SKILL Definition

**Agent ID:** `flight_dynamics_specialist`
**Domain:** Flight Dynamics — 6-DOF, Stability Derivatives, Trim, Linearisation, Dutch Roll
...
The Flight Dynamics Specialist performs flight dynamics analysis, synthesising results
...
|---|---|---|
| Core flight dynamics analysis (analytical) | Active (MVP) | Level 1 capability |
| Flight Dynamics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical flight dynamics methods | Planned (V1) | Level 3 |
| Multi-physics flight dynamics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain flight dynamics optimisation | Planned (V3) | Level 5 Master |
...
Every Flight Dynamics Specialist output MUST include:
...
6. `flight_dynamics_summary` — structured domain summary (see Output Contract)
...
Raise **[FLIGHT DYNAMICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core flight dynamics analysis — analytical methods |
...
- **Regime violation**: applying flight dynamics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Flight Dynamics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "flight_dynamics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for flight dynamics
