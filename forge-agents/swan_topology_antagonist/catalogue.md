# Swan Topology Antagonist — Capability Catalogue
...
The Swan Topology Antagonist performs rigorous domain-specific critique of
`swan_topology_specialist` outputs.
...
|---|---|---|
| Critique an analytical swan_topology output | Medium | Planned |
