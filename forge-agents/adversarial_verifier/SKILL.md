# Adversarial Verifier — SKILL Definition

**Agent ID:** `adversarial_verifier`
**Domain:** Adversarial Verification — Stress Testing, Edge Case Detection
...
The Adversarial Verifier performs adversarial verification analysis, synthesising results
...
|---|---|---|
| Core adversarial verification analysis (analytical) | Active (MVP) | Level 1 capability |
| Adversarial Verification design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical adversarial verification methods | Planned (V1) | Level 3 |
| Multi-physics adversarial verification coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain adversarial verification optimisation | Planned (V3) | Level 5 Master |
...
Every Adversarial Verifier output MUST include:
...
6. `adversarial_verification_summary` — structured domain summary (see Output Contract)
...
Raise **[ADVERSARIAL VERIFICATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core adversarial verification analysis — analytical methods |
...
- **Regime violation**: applying adversarial verification method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "adversarial verification Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "adversarial_verifier"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for adversarial verification
