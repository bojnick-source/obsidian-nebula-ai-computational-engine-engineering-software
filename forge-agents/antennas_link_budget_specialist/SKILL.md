# Antennas Link Budget Specialist — SKILL Definition

**Agent ID:** `antennas_link_budget_specialist`
**Domain:** Antennas & Link Budget — Gain, Pattern, EIRP, G/T, Fade Margin, Polarisation
...
The Antennas Link Budget Specialist performs antennas & link budget analysis, synthesising results
...
|---|---|---|
| Core antennas & link budget analysis (analytical) | Active (MVP) | Level 1 capability |
| Antennas & Link Budget design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical antennas & link budget methods | Planned (V1) | Level 3 |
| Multi-physics antennas & link budget coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain antennas & link budget optimisation | Planned (V3) | Level 5 Master |
...
Every Antennas Link Budget Specialist output MUST include:
...
6. `antennas_&_link_budget_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
antennas_&_link_budget_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[ANTENNAS & LINK BUDGET SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core antennas & link budget analysis — analytical methods |
...
- **Regime violation**: applying antennas & link budget method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Antennas & Link Budget Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "antennas_link_budget_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for antennas & link budget
