# Forge Arbiter — SKILL Definition

**Agent ID:** `forge_arbiter`
**Domain:** FORGE Arbiter — Dispute resolution, deadlock breaking, verdict aggregation
...
The Forge Arbiter performs forge arbiter analysis, synthesising results
...
|---|---|---|
| Core forge arbiter analysis (analytical) | Active (MVP) | Level 1 capability |
| Forge Arbiter design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical forge arbiter methods | Planned (V1) | Level 3 |
| Multi-physics forge arbiter coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain forge arbiter optimisation | Planned (V3) | Level 5 Master |
...
Every Forge Arbiter output MUST include:
...
6. `forge_arbiter_summary` — structured domain summary (see Output Contract)
...
Raise **[FORGE ARBITER SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core forge arbiter analysis — analytical methods |
...
- **Regime violation**: applying forge arbiter method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "FORGE Arbiter Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "forge_arbiter"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for forge arbiter
