# Propulsion Specialist — SKILL Definition

**Agent ID:** `propulsion_specialist`
**Domain:** Propulsion Engineering — Rocket, Jet Propulsion, Combustion, Nozzle Design
...
The Propulsion Specialist performs propulsion analysis, synthesising results
...
|---|---|---|
| Core propulsion analysis (analytical) | Active (MVP) | Level 1 capability |
| Propulsion design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical propulsion methods | Planned (V1) | Level 3 |
| Multi-physics propulsion coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain propulsion optimisation | Planned (V3) | Level 5 Master |
...
Every Propulsion Specialist output MUST include:
...
6. `propulsion_summary` — structured domain summary (see Output Contract)
...
Raise **[PROPULSION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core propulsion analysis — analytical methods |
...
- **Regime violation**: applying propulsion method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "propulsion Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "propulsion_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for propulsion
