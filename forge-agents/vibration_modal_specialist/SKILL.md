# Vibration Modal Specialist — SKILL Definition

**Agent ID:** `vibration_modal_specialist`
**Domain:** Vibration & Modal Analysis — Natural Frequencies, Mode Shapes, FRF
...
The Vibration Modal Specialist performs vibration & modal analysis, synthesising results
...
|---|---|---|
| Core vibration & modal analysis (analytical) | Active (MVP) | Level 1 capability |
| Vibration & Modal design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical vibration & modal methods | Planned (V1) | Level 3 |
| Multi-physics vibration & modal coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain vibration & modal optimisation | Planned (V3) | Level 5 Master |
...
Every Vibration Modal Specialist output MUST include:
...
6. `vibration_&_modal_summary` — structured domain summary (see Output Contract)
...
Raise **[VIBRATION & MODAL SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core vibration & modal analysis — analytical methods |
...
- **Regime violation**: applying vibration & modal method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Vibration & Modal Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "vibration_modal_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for vibration & modal
