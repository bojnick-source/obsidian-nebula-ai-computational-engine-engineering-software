# Prompt Registry Auditor — SKILL Definition

**Agent ID:** `prompt_registry_auditor`
**Domain:** Prompt Registry Auditor — Prompt version compliance, changelog completeness
...
The Prompt Registry Auditor performs prompt registry auditor analysis, synthesising results
...
|---|---|---|
| Core prompt registry auditor analysis (analytical) | Active (MVP) | Level 1 capability |
| Prompt Registry Auditor design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical prompt registry auditor methods | Planned (V1) | Level 3 |
| Multi-physics prompt registry auditor coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain prompt registry auditor optimisation | Planned (V3) | Level 5 Master |
...
Every Prompt Registry Auditor output MUST include:
...
6. `prompt_registry_auditor_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
prompt_registry_auditor_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[PROMPT REGISTRY AUDITOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core prompt registry auditor analysis — analytical methods |
...
- **Regime violation**: applying prompt registry auditor method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Prompt Registry Auditor Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "prompt_registry_auditor"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for prompt registry auditor
