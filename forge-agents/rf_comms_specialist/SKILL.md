# Rf Comms Specialist — SKILL Definition

**Agent ID:** `rf_comms_specialist`
**Domain:** RF & Comms — Link Budget, Modulation, Propagation, Data Rate, Spectrum
...
The Rf Comms Specialist performs rf & comms analysis, synthesising results
...
|---|---|---|
| Core rf & comms analysis (analytical) | Active (MVP) | Level 1 capability |
| Rf & Comms design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical rf & comms methods | Planned (V1) | Level 3 |
| Multi-physics rf & comms coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain rf & comms optimisation | Planned (V3) | Level 5 Master |
...
Every Rf Comms Specialist output MUST include:
...
6. `rf_&_comms_summary` — structured domain summary (see Output Contract)
...
Raise **[RF & COMMS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core rf & comms analysis — analytical methods |
...
- **Regime violation**: applying rf & comms method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "RF & Comms Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "rf_comms_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for rf & comms
