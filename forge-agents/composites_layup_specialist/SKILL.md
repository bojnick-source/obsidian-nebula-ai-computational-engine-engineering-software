# Composites Layup Specialist — SKILL Definition

**Agent ID:** `composites_layup_specialist`
**Domain:** Composites Layup — CLT, Ply Orientation, First Ply Failure, Interlaminar Shear
...
The Composites Layup Specialist performs composites layup analysis, synthesising results
...
|---|---|---|
| Core composites layup analysis (analytical) | Active (MVP) | Level 1 capability |
| Composites Layup design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical composites layup methods | Planned (V1) | Level 3 |
| Multi-physics composites layup coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain composites layup optimisation | Planned (V3) | Level 5 Master |
...
Every Composites Layup Specialist output MUST include:
...
6. `composites_layup_summary` — structured domain summary (see Output Contract)
...
Raise **[COMPOSITES LAYUP SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core composites layup analysis — analytical methods |
...
- **Regime violation**: applying composites layup method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Composites Layup Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "composites_layup_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for composites layup
