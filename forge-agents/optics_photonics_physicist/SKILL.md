# Optics Photonics Physicist — SKILL Definition

**Agent ID:** `optics_photonics_physicist`
**Domain:** Optics and Photonics — Wave Optics, Lasers, Nonlinear Optics
...
The Optics Photonics Physicist performs optics and photonics analysis, synthesising results
...
|---|---|---|
| Core optics and photonics analysis (analytical) | Active (MVP) | Level 1 capability |
| Optics And Photonics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical optics and photonics methods | Planned (V1) | Level 3 |
| Multi-physics optics and photonics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain optics and photonics optimisation | Planned (V3) | Level 5 Master |
...
Every Optics Photonics Physicist output MUST include:
...
6. `optics_and_photonics_summary` — structured domain summary (see Output Contract)
...
Raise **[OPTICS AND PHOTONICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core optics and photonics analysis — analytical methods |
...
- **Regime violation**: applying optics and photonics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "optics and photonics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "optics_photonics_physicist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for optics and photonics
