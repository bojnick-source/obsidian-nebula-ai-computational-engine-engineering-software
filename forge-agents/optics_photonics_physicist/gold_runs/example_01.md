---
run_id: gr-001
task: "Demonstrate correct optics and photonics analysis with explicit assumptions"
difficulty: medium
outcome: pass
confidence: 0.00
date: 2026-03-12
...
from a real run of `optics_photonics_physicist` once the agent completes its first successful task.*

Suggested first gold run task:
- A representative optics and photonics problem at Level 1 (analytical method)
