# Energy Maneuverability Specialist — SKILL Definition

**Agent ID:** `energy_maneuverability_specialist`
**Domain:** Energy Maneuverability — E-M Diagram, Turn Rate, Load Factor, Specific Excess Power
...
The Energy Maneuverability Specialist performs energy maneuverability analysis, synthesising results
...
|---|---|---|
| Core energy maneuverability analysis (analytical) | Active (MVP) | Level 1 capability |
| Energy Maneuverability design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical energy maneuverability methods | Planned (V1) | Level 3 |
| Multi-physics energy maneuverability coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain energy maneuverability optimisation | Planned (V3) | Level 5 Master |
...
Every Energy Maneuverability Specialist output MUST include:
...
6. `energy_maneuverability_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
energy_maneuverability_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[ENERGY MANEUVERABILITY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core energy maneuverability analysis — analytical methods |
...
- **Regime violation**: applying energy maneuverability method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Energy Maneuverability Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "energy_maneuverability_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for energy maneuverability
