# Contradiction Verifier — SKILL Definition

**Agent ID:** `contradiction_verifier`
**Domain:** Contradiction Verifier — Cross-agent consistency, logical contradiction detection
...
The Contradiction Verifier performs contradiction verifier analysis, synthesising results
...
|---|---|---|
| Core contradiction verifier analysis (analytical) | Active (MVP) | Level 1 capability |
| Contradiction Verifier design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical contradiction verifier methods | Planned (V1) | Level 3 |
| Multi-physics contradiction verifier coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain contradiction verifier optimisation | Planned (V3) | Level 5 Master |
...
Every Contradiction Verifier output MUST include:
...
6. `contradiction_verifier_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
contradiction_verifier_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[CONTRADICTION VERIFIER SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core contradiction verifier analysis — analytical methods |
...
- **Regime violation**: applying contradiction verifier method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Contradiction Verifier Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "contradiction_verifier"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for contradiction verifier
