# Power Distribution Specialist — SKILL Definition

**Agent ID:** `power_distribution_specialist`
**Domain:** Power Distribution — Bus Architecture, Fusing, Wire Sizing, Load Analysis, Harness
...
The Power Distribution Specialist performs power distribution analysis, synthesising results
...
|---|---|---|
| Core power distribution analysis (analytical) | Active (MVP) | Level 1 capability |
| Power Distribution design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical power distribution methods | Planned (V1) | Level 3 |
| Multi-physics power distribution coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain power distribution optimisation | Planned (V3) | Level 5 Master |
...
Every Power Distribution Specialist output MUST include:
...
6. `power_distribution_summary` — structured domain summary (see Output Contract)
...
Raise **[POWER DISTRIBUTION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core power distribution analysis — analytical methods |
...
- **Regime violation**: applying power distribution method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Power Distribution Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "power_distribution_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for power distribution
