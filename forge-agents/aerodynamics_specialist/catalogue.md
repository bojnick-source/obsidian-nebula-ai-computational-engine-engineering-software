# Aerodynamics Specialist — Capability Catalogue

**Agent ID:** `aerodynamics_specialist`
**Role:** Specialist
**Domain:** Aerodynamics — Lift, Drag, Propulsion, CFD
...
The Aerodynamics Specialist performs aerodynamics analysis at Level 1
...
|---|---|---|
| Basic aerodynamics sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Aerodynamics design optimisation | Hard | Planned |
| Multi-physics aerodynamics coupling | Expert | Planned (Level 4) |
