# Tester Core Runtime — SKILL Definition

**Agent ID:** `tester_core_runtime`
**Domain:** Tester — Core Runtime — Agent invocation, task lifecycle, blackboard I/O
...
The Tester Core Runtime performs tester core runtime analysis, synthesising results
...
|---|---|---|
| Core tester core runtime analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Core Runtime design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester core runtime methods | Planned (V1) | Level 3 |
| Multi-physics tester core runtime coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester core runtime optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Core Runtime output MUST include:
...
6. `tester_core_runtime_summary` — structured domain summary (see Output Contract)
...
Raise **[TESTER CORE RUNTIME SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester core runtime analysis — analytical methods |
...
- **Regime violation**: applying tester core runtime method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Core Runtime Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_core_runtime"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester core runtime
