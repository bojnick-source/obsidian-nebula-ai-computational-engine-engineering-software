# Photonics Optical Specialist — SKILL Definition

**Agent ID:** `photonics_optical_specialist`
**Domain:** Photonics & Optics — Laser Design, Optical Systems, Waveguides
...
The Photonics Optical Specialist performs photonics analysis analysis, synthesising results
...
|---|---|---|
| Core photonics analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Photonics Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical photonics analysis methods | Planned (V1) | Level 3 |
| Multi-physics photonics analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain photonics analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Photonics Optical Specialist output MUST include:
...
6. `photonics_analysis_summary` — structured domain summary (see Output Contract)
...
Raise **[PHOTONICS ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core photonics analysis analysis — analytical methods |
...
- **Regime violation**: applying photonics analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "photonics analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "photonics_optical_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for photonics analysis
