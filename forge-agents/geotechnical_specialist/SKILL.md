# Geotechnical Specialist — SKILL Definition

**Agent ID:** `geotechnical_specialist`
**Domain:** Geotechnical Engineering — Soil Mechanics, Foundation Design, Slope Stability
...
The Geotechnical Specialist performs geotechnical analysis, synthesising results
...
|---|---|---|
| Core geotechnical analysis (analytical) | Active (MVP) | Level 1 capability |
| Geotechnical design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical geotechnical methods | Planned (V1) | Level 3 |
| Multi-physics geotechnical coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain geotechnical optimisation | Planned (V3) | Level 5 Master |
...
Every Geotechnical Specialist output MUST include:
...
6. `geotechnical_summary` — structured domain summary (see Output Contract)
...
Raise **[GEOTECHNICAL SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core geotechnical analysis — analytical methods |
...
- **Regime violation**: applying geotechnical method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "geotechnical Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "geotechnical_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for geotechnical
