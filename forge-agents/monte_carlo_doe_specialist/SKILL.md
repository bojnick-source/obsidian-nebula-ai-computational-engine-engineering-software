# Monte Carlo Doe Specialist — SKILL Definition

**Agent ID:** `monte_carlo_doe_specialist`
**Domain:** Monte Carlo & DOE — MC Sampling, Latin Hypercube, RSM, Full Factorial, Taguchi
...
The Monte Carlo Doe Specialist performs monte carlo & doe analysis, synthesising results
...
|---|---|---|
| Core monte carlo & doe analysis (analytical) | Active (MVP) | Level 1 capability |
| Monte Carlo & Doe design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical monte carlo & doe methods | Planned (V1) | Level 3 |
| Multi-physics monte carlo & doe coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain monte carlo & doe optimisation | Planned (V3) | Level 5 Master |
...
Every Monte Carlo Doe Specialist output MUST include:
...
6. `monte_carlo_&_doe_summary` — structured domain summary (see Output Contract)
...
Raise **[MONTE CARLO & DOE SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core monte carlo & doe analysis — analytical methods |
...
- **Regime violation**: applying monte carlo & doe method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Monte Carlo & DOE Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "monte_carlo_doe_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for monte carlo & doe
