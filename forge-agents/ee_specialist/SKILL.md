# Ee Specialist — SKILL Definition

**Agent ID:** `ee_specialist`
**Domain:** Electrical Engineering — Circuit Design, Signal Analysis, Power Systems
...
The Ee Specialist performs electrical engineering analysis, synthesising results
...
|---|---|---|
| Core electrical engineering analysis (analytical) | Active (MVP) | Level 1 capability |
| Electrical Engineering design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical electrical engineering methods | Planned (V1) | Level 3 |
| Multi-physics electrical engineering coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain electrical engineering optimisation | Planned (V3) | Level 5 Master |
...
Every Ee Specialist output MUST include:
...
6. `electrical_engineering_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
electrical_engineering_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[ELECTRICAL ENGINEERING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core electrical engineering analysis — analytical methods |
...
- **Regime violation**: applying electrical engineering method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "electrical engineering Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "ee_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for electrical engineering
