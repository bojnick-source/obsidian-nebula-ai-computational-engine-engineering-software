# Tester Contracts Interfaces — SKILL Definition

**Agent ID:** `tester_contracts_interfaces`
**Domain:** Tester — Contracts & Interfaces — Output contract compliance, schema validation
...
The Tester Contracts Interfaces performs tester contracts & interfaces analysis, synthesising results
...
|---|---|---|
| Core tester contracts & interfaces analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Contracts & Interfaces design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester contracts & interfaces methods | Planned (V1) | Level 3 |
| Multi-physics tester contracts & interfaces coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester contracts & interfaces optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Contracts Interfaces output MUST include:
...
6. `tester_contracts_&_interfaces_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
tester_contracts_&_interfaces_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[TESTER CONTRACTS & INTERFACES SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester contracts & interfaces analysis — analytical methods |
...
- **Regime violation**: applying tester contracts & interfaces method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Contracts & Interfaces Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_contracts_interfaces"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester contracts & interfaces
