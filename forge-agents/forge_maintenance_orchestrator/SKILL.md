# Forge Maintenance Orchestrator — SKILL Definition

**Agent ID:** `forge_maintenance_orchestrator`
**Domain:** FORGE Maintenance Orchestrator — Self-maintenance, anti-drift, schema audits
...
The Forge Maintenance Orchestrator performs forge maintenance orchestrator analysis, synthesising results
...
|---|---|---|
| Core forge maintenance orchestrator analysis (analytical) | Active (MVP) | Level 1 capability |
| Forge Maintenance Orchestrator design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical forge maintenance orchestrator methods | Planned (V1) | Level 3 |
| Multi-physics forge maintenance orchestrator coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain forge maintenance orchestrator optimisation | Planned (V3) | Level 5 Master |
...
Every Forge Maintenance Orchestrator output MUST include:
...
6. `forge_maintenance_orchestrator_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
forge_maintenance_orchestrator_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[FORGE MAINTENANCE ORCHESTRATOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core forge maintenance orchestrator analysis — analytical methods |
...
- **Regime violation**: applying forge maintenance orchestrator method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "FORGE Maintenance Orchestrator Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "forge_maintenance_orchestrator"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for forge maintenance orchestrator
