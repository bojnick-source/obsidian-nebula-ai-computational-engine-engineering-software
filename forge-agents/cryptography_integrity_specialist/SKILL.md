# Cryptography Integrity Specialist — SKILL Definition

**Agent ID:** `cryptography_integrity_specialist`
**Domain:** Cryptography & Integrity — Hashing, Signing, Encryption, Certificate Management
...
The Cryptography Integrity Specialist performs cryptography & integrity analysis, synthesising results
...
|---|---|---|
| Core cryptography & integrity analysis (analytical) | Active (MVP) | Level 1 capability |
| Cryptography & Integrity design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical cryptography & integrity methods | Planned (V1) | Level 3 |
| Multi-physics cryptography & integrity coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain cryptography & integrity optimisation | Planned (V3) | Level 5 Master |
...
Every Cryptography Integrity Specialist output MUST include:
...
6. `cryptography_&_integrity_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
cryptography_&_integrity_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[CRYPTOGRAPHY & INTEGRITY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core cryptography & integrity analysis — analytical methods |
...
- **Regime violation**: applying cryptography & integrity method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Cryptography & Integrity Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "cryptography_integrity_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for cryptography & integrity
