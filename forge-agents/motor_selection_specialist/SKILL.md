# Motor Selection Specialist — SKILL Definition

**Agent ID:** `motor_selection_specialist`
**Domain:** Motor Selection — BLDC/PMSM, kV Rating, Torque-Speed, Thermal Limits, ESC
...
The Motor Selection Specialist performs motor selection analysis, synthesising results
...
|---|---|---|
| Core motor selection analysis (analytical) | Active (MVP) | Level 1 capability |
| Motor Selection design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical motor selection methods | Planned (V1) | Level 3 |
| Multi-physics motor selection coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain motor selection optimisation | Planned (V3) | Level 5 Master |
...
Every Motor Selection Specialist output MUST include:
...
6. `motor_selection_summary` — structured domain summary (see Output Contract)
...
Raise **[MOTOR SELECTION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core motor selection analysis — analytical methods |
...
- **Regime violation**: applying motor selection method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Motor Selection Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "motor_selection_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for motor selection
