# Biomedical Engineer — Capability Catalogue
...
The Biomedical Engineer performs biomedical analysis at Level 1
...
|---|---|---|
| Basic biomedical sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Biomedical design optimisation | Hard | Planned |
| Multi-physics biomedical coupling | Expert | Planned (Level 4) |
