# Biomedical Engineer — SKILL Definition

**Agent ID:** `biomedical_engineer`
**Domain:** Biomedical Engineering — Biomechanics, Medical Devices, FDA Compliance
...
The Biomedical Engineer performs biomedical analysis, synthesising results
...
|---|---|---|
| Core biomedical analysis (analytical) | Active (MVP) | Level 1 capability |
| Biomedical design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical biomedical methods | Planned (V1) | Level 3 |
| Multi-physics biomedical coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain biomedical optimisation | Planned (V3) | Level 5 Master |
...
Every Biomedical Engineer output MUST include:
...
6. `biomedical_summary` — structured domain summary (see Output Contract)
...
Raise **[BIOMEDICAL SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core biomedical analysis — analytical methods |
...
- **Regime violation**: applying biomedical method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "biomedical Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "biomedical_engineer"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for biomedical
