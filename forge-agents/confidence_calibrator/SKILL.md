# Confidence Calibrator — SKILL Definition

**Agent ID:** `confidence_calibrator`
**Domain:** Confidence Calibrator — Declared vs measured confidence, Brier score tracking
...
The Confidence Calibrator performs confidence calibrator analysis, synthesising results
...
|---|---|---|
| Core confidence calibrator analysis (analytical) | Active (MVP) | Level 1 capability |
| Confidence Calibrator design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical confidence calibrator methods | Planned (V1) | Level 3 |
| Multi-physics confidence calibrator coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain confidence calibrator optimisation | Planned (V3) | Level 5 Master |
...
Every Confidence Calibrator output MUST include:
...
6. `confidence_calibrator_summary` — structured domain summary (see Output Contract)
...
Raise **[CONFIDENCE CALIBRATOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core confidence calibrator analysis — analytical methods |
...
- **Regime violation**: applying confidence calibrator method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Confidence Calibrator Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "confidence_calibrator"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for confidence calibrator
