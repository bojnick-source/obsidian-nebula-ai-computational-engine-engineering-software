# Structural Mechanics Specialist — SKILL Definition

**Agent ID:** `structural_mechanics_specialist`
**Domain:** Structural Mechanics — Stress, Strain, Beams, Plates, Shells
...
The Structural Mechanics Specialist performs structural mechanics analysis, synthesising results
...
|---|---|---|
| Core structural mechanics analysis (analytical) | Active (MVP) | Level 1 capability |
| Structural Mechanics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical structural mechanics methods | Planned (V1) | Level 3 |
| Multi-physics structural mechanics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain structural mechanics optimisation | Planned (V3) | Level 5 Master |
...
Every Structural Mechanics Specialist output MUST include:
...
6. `structural_mechanics_summary` — structured domain summary (see Output Contract)
...
Raise **[STRUCTURAL MECHANICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core structural mechanics analysis — analytical methods |
...
- **Regime violation**: applying structural mechanics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Structural Mechanics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "structural_mechanics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for structural mechanics
