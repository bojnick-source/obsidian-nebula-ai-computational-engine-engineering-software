# Topology Optimization Specialist — SKILL Definition

**Agent ID:** `topology_optimization_specialist`
**Domain:** Topology Optimisation — SIMP, Level Set, Density Filter, Volume Constraint
...
The Topology Optimization Specialist performs topology optimisation analysis, synthesising results
...
|---|---|---|
| Core topology optimisation analysis (analytical) | Active (MVP) | Level 1 capability |
| Topology Optimisation design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical topology optimisation methods | Planned (V1) | Level 3 |
| Multi-physics topology optimisation coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain topology optimisation optimisation | Planned (V3) | Level 5 Master |
...
Every Topology Optimization Specialist output MUST include:
...
6. `topology_optimisation_summary` — structured domain summary (see Output Contract)
...
Raise **[TOPOLOGY OPTIMISATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core topology optimisation analysis — analytical methods |
...
- **Regime violation**: applying topology optimisation method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Topology Optimisation Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "topology_optimization_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for topology optimisation
