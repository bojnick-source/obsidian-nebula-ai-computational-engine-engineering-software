# Coaxial Interference Specialist — SKILL Definition

**Agent ID:** `coaxial_interference_specialist`
**Domain:** Coaxial Interference — Coaxial Rotor Interaction, Induced Velocity, Thrust Loss
...
The Coaxial Interference Specialist performs coaxial interference analysis, synthesising results
...
|---|---|---|
| Core coaxial interference analysis (analytical) | Active (MVP) | Level 1 capability |
| Coaxial Interference design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical coaxial interference methods | Planned (V1) | Level 3 |
| Multi-physics coaxial interference coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain coaxial interference optimisation | Planned (V3) | Level 5 Master |
...
Every Coaxial Interference Specialist output MUST include:
...
6. `coaxial_interference_summary` — structured domain summary (see Output Contract)
...
Raise **[COAXIAL INTERFERENCE SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core coaxial interference analysis — analytical methods |
...
- **Regime violation**: applying coaxial interference method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Coaxial Interference Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "coaxial_interference_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for coaxial interference
