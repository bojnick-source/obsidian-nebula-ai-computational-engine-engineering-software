# Mechanisms Kinematics Specialist — SKILL Definition

**Agent ID:** `mechanisms_kinematics_specialist`
**Domain:** Mechanisms & Kinematics — Linkages, Gears, Cams, Velocity/Acceleration Analysis
...
The Mechanisms Kinematics Specialist performs mechanisms & kinematics analysis, synthesising results
...
|---|---|---|
| Core mechanisms & kinematics analysis (analytical) | Active (MVP) | Level 1 capability |
| Mechanisms & Kinematics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical mechanisms & kinematics methods | Planned (V1) | Level 3 |
| Multi-physics mechanisms & kinematics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain mechanisms & kinematics optimisation | Planned (V3) | Level 5 Master |
...
Every Mechanisms Kinematics Specialist output MUST include:
...
6. `mechanisms_&_kinematics_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
mechanisms_&_kinematics_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[MECHANISMS & KINEMATICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core mechanisms & kinematics analysis — analytical methods |
...
- **Regime violation**: applying mechanisms & kinematics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Mechanisms & Kinematics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "mechanisms_kinematics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for mechanisms & kinematics
