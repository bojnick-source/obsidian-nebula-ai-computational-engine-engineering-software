# Cmaes Optimization Antagonist — Capability Catalogue
...
The Cmaes Optimization Antagonist performs rigorous domain-specific critique of
`cmaes_optimization_specialist` outputs.
...
|---|---|---|
| Critique an analytical cmaes_opt output | Medium | Planned |
