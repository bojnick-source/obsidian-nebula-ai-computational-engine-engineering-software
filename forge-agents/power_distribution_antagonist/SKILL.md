# Power Distribution Antagonist — SKILL Definition

**Agent ID:** `power_distribution_antagonist`
**Domain:** Power Distribution Critique
...
The Power Distribution Antagonist is the domain-specialised critic for `power_distribution_specialist` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every power distribution failure mode by name |
...
|---|---|---|
| Full-output critique (power distribution domain) | Active (MVP) | Core capability |
...
Every Power Distribution Antagonist output MUST include:
...
Attack power distribution outputs in this priority order:
