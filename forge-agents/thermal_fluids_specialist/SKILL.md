# Thermal Fluids Specialist — SKILL Definition

**Agent ID:** `thermal_fluids_specialist`
**Domain:** Thermal-Fluids — Heat Transfer, CFD, Fluid Dynamics
...
The Thermal Fluids Specialist performs thermal-fluids analysis analysis, synthesising results
...
|---|---|---|
| Core thermal-fluids analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Thermal-Fluids Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical thermal-fluids analysis methods | Planned (V1) | Level 3 |
| Multi-physics thermal-fluids analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain thermal-fluids analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Thermal Fluids Specialist output MUST include:
...
6. `thermal_fluids_analysis_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
thermal_fluids_analysis_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[THERMAL-FLUIDS ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core thermal-fluids analysis analysis — analytical methods |
...
- **Regime violation**: applying thermal-fluids analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "thermal-fluids analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "thermal_fluids_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for thermal-fluids analysis
