# Schema Auditor — SKILL Definition

**Agent ID:** `schema_auditor`
**Domain:** Schema Auditor — YAML/JSON schema compliance, version drift detection
...
The Schema Auditor performs schema auditor analysis, synthesising results
...
|---|---|---|
| Core schema auditor analysis (analytical) | Active (MVP) | Level 1 capability |
| Schema Auditor design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical schema auditor methods | Planned (V1) | Level 3 |
| Multi-physics schema auditor coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain schema auditor optimisation | Planned (V3) | Level 5 Master |
...
Every Schema Auditor output MUST include:
...
6. `schema_auditor_summary` — structured domain summary (see Output Contract)
...
Raise **[SCHEMA AUDITOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core schema auditor analysis — analytical methods |
...
- **Regime violation**: applying schema auditor method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Schema Auditor Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "schema_auditor"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for schema auditor
