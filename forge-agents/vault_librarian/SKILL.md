# Vault Librarian — SKILL Definition

**Agent ID:** `vault_librarian`
**Domain:** Vault Librarian — Knowledge retrieval, vault reads/writes, provenance lookup
...
The Vault Librarian performs vault librarian analysis, synthesising results
...
|---|---|---|
| Core vault librarian analysis (analytical) | Active (MVP) | Level 1 capability |
| Vault Librarian design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical vault librarian methods | Planned (V1) | Level 3 |
| Multi-physics vault librarian coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain vault librarian optimisation | Planned (V3) | Level 5 Master |
...
Every Vault Librarian output MUST include:
...
6. `vault_librarian_summary` — structured domain summary (see Output Contract)
...
Raise **[VAULT LIBRARIAN SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core vault librarian analysis — analytical methods |
...
- **Regime violation**: applying vault librarian method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Vault Librarian Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "vault_librarian"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for vault librarian
