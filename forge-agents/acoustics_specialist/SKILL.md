# Acoustics Specialist — SKILL Definition

**Agent ID:** `acoustics_specialist`
**Domain:** Acoustics — Sound Propagation, Vibration, Noise Control
...
The Acoustics Specialist performs acoustics analysis analysis, synthesising results
...
|---|---|---|
| Core acoustics analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Acoustics Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical acoustics analysis methods | Planned (V1) | Level 3 |
| Multi-physics acoustics analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain acoustics analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Acoustics Specialist output MUST include:
...
6. `acoustics_analysis_summary` — structured domain summary (see Output Contract)
...
Raise **[ACOUSTICS ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core acoustics analysis analysis — analytical methods |
...
- **Regime violation**: applying acoustics analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "acoustics analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "acoustics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for acoustics analysis
