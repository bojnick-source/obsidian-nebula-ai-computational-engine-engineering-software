# Airfoils Wings Specialist — SKILL Definition

**Agent ID:** `airfoils_wings_specialist`
**Domain:** Airfoils & Wings — Section Analysis, Lift Curve, Drag Polar, Wing Loading
...
The Airfoils Wings Specialist performs airfoils & wings analysis, synthesising results
...
|---|---|---|
| Core airfoils & wings analysis (analytical) | Active (MVP) | Level 1 capability |
| Airfoils & Wings design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical airfoils & wings methods | Planned (V1) | Level 3 |
| Multi-physics airfoils & wings coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain airfoils & wings optimisation | Planned (V3) | Level 5 Master |
...
Every Airfoils Wings Specialist output MUST include:
...
6. `airfoils_&_wings_summary` — structured domain summary (see Output Contract)
...
Raise **[AIRFOILS & WINGS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core airfoils & wings analysis — analytical methods |
...
- **Regime violation**: applying airfoils & wings method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Airfoils & Wings Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "airfoils_wings_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for airfoils & wings
