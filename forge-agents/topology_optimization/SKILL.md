# Topology Optimization — SKILL Definition

**Agent ID:** `topology_optimization`
**Domain:** Topology Optimization — SIMP, Level-Set, AM Constraints
...
The Topology Optimization performs topology optimization analysis, synthesising results
...
|---|---|---|
| Core topology optimization analysis (analytical) | Active (MVP) | Level 1 capability |
| Topology Optimization design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical topology optimization methods | Planned (V1) | Level 3 |
| Multi-physics topology optimization coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain topology optimization optimisation | Planned (V3) | Level 5 Master |
...
Every Topology Optimization output MUST include:
...
6. `topology_optimization_summary` — structured domain summary (see Output Contract)
...
Raise **[TOPOLOGY OPTIMIZATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core topology optimization analysis — analytical methods |
...
- **Regime violation**: applying topology optimization method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "topology optimization Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "topology_optimization"
  target_run_id: "..."
