# Actuator Safety Antagonist — Capability Catalogue
...
The Actuator Safety Antagonist performs rigorous domain-specific critique of
`actuator_safety_specialist` outputs.
...
|---|---|---|
| Critique an analytical actuator_safety output | Medium | Planned |
