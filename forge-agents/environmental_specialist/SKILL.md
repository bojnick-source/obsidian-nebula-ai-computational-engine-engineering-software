# Environmental Specialist — SKILL Definition

**Agent ID:** `environmental_specialist`
**Domain:** Environmental Engineering — Lifecycle, Sustainability, Emissions
...
The Environmental Specialist performs environmental analysis analysis, synthesising results
...
|---|---|---|
| Core environmental analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Environmental Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical environmental analysis methods | Planned (V1) | Level 3 |
| Multi-physics environmental analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain environmental analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Environmental Specialist output MUST include:
...
6. `environmental_analysis_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
environmental_analysis_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[ENVIRONMENTAL ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core environmental analysis analysis — analytical methods |
...
- **Regime violation**: applying environmental analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "environmental analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "environmental_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for environmental analysis
