# Environmental Specialist — Capability Catalogue

**Agent ID:** `environmental_specialist`
**Role:** Specialist
**Domain:** Environmental Engineering — Pollution Modeling, Lifecycle Analysis, Regulatory Compliance
...
The Environmental Specialist performs environmental analysis at Level 1
...
|---|---|---|
| Basic environmental sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Environmental design optimisation | Hard | Planned |
| Multi-physics environmental coupling | Expert | Planned (Level 4) |
