# Dfa Dfm Specialist — SKILL Definition

**Agent ID:** `dfa_dfm_specialist`
**Domain:** DFA/DFM — Design for Assembly, Design for Manufacture, Tolerance Stack-up
...
The Dfa Dfm Specialist performs dfa/dfm analysis, synthesising results
...
|---|---|---|
| Core dfa/dfm analysis (analytical) | Active (MVP) | Level 1 capability |
| Dfa/Dfm design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical dfa/dfm methods | Planned (V1) | Level 3 |
| Multi-physics dfa/dfm coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain dfa/dfm optimisation | Planned (V3) | Level 5 Master |
...
Every Dfa Dfm Specialist output MUST include:
...
6. `dfa/dfm_summary` — structured domain summary (see Output Contract)
...
Raise **[DFA/DFM SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core dfa/dfm analysis — analytical methods |
...
- **Regime violation**: applying dfa/dfm method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "DFA/DFM Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "dfa_dfm_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for dfa/dfm
