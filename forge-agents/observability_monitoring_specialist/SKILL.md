# Observability Monitoring Specialist — SKILL Definition

**Agent ID:** `observability_monitoring_specialist`
**Domain:** Observability & Monitoring — Metrics, Distributed Tracing, Dashboards, Alerting, SLOs
...
The Observability Monitoring Specialist performs observability & monitoring analysis, synthesising results
...
|---|---|---|
| Core observability & monitoring analysis (analytical) | Active (MVP) | Level 1 capability |
| Observability & Monitoring design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical observability & monitoring methods | Planned (V1) | Level 3 |
| Multi-physics observability & monitoring coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain observability & monitoring optimisation | Planned (V3) | Level 5 Master |
...
Every Observability Monitoring Specialist output MUST include:
...
6. `observability_&_monitoring_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
observability_&_monitoring_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[OBSERVABILITY & MONITORING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core observability & monitoring analysis — analytical methods |
...
- **Regime violation**: applying observability & monitoring method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Observability & Monitoring Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "observability_monitoring_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for observability & monitoring
