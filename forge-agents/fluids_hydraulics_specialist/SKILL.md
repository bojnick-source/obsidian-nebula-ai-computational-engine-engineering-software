# Fluids Hydraulics Specialist — SKILL Definition

**Agent ID:** `fluids_hydraulics_specialist`
**Domain:** Fluids & Hydraulics — Incompressible Flow, Pipe Systems, Pumps, Actuators
...
The Fluids Hydraulics Specialist performs fluids & hydraulics analysis, synthesising results
...
|---|---|---|
| Core fluids & hydraulics analysis (analytical) | Active (MVP) | Level 1 capability |
| Fluids & Hydraulics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical fluids & hydraulics methods | Planned (V1) | Level 3 |
| Multi-physics fluids & hydraulics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain fluids & hydraulics optimisation | Planned (V3) | Level 5 Master |
...
Every Fluids Hydraulics Specialist output MUST include:
...
6. `fluids_&_hydraulics_summary` — structured domain summary (see Output Contract)
...
Raise **[FLUIDS & HYDRAULICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core fluids & hydraulics analysis — analytical methods |
...
- **Regime violation**: applying fluids & hydraulics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Fluids & Hydraulics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "fluids_hydraulics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for fluids & hydraulics
