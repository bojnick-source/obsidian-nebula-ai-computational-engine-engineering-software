# Geometry Meshing Antagonist — SKILL Definition

**Agent ID:** `geometry_meshing_antagonist`
**Domain:** Geometry & Meshing Critique
...
The Geometry Meshing Antagonist is the domain-specialised critic for `geometry_meshing_specialist` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every geometry & meshing failure mode by name |
...
|---|---|---|
| Full-output critique (geometry & meshing domain) | Active (MVP) | Core capability |
...
Every Geometry Meshing Antagonist output MUST include:
...
Attack geometry & meshing outputs in this priority order:
