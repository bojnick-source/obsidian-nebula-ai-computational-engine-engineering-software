# Component Generation — SKILL Definition

**Agent ID:** `component_generation`
**Domain:** Component Generation — Parametric Design, CAD Generation
...
The Component Generation performs component generation analysis, synthesising results
...
|---|---|---|
| Core component generation analysis (analytical) | Active (MVP) | Level 1 capability |
| Component Generation design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical component generation methods | Planned (V1) | Level 3 |
| Multi-physics component generation coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain component generation optimisation | Planned (V3) | Level 5 Master |
...
Every Component Generation output MUST include:
...
6. `component_generation_summary` — structured domain summary (see Output Contract)
...
Raise **[COMPONENT GENERATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core component generation analysis — analytical methods |
...
- **Regime violation**: applying component generation method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "component generation Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "component_generation"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for component generation
