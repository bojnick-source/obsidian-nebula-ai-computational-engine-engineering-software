# Shape Kernel Specialist — Capability Catalogue
...
The Shape Kernel Specialist performs shape_kernel analysis at Level 1
...
|---|---|---|
| Basic shape_kernel sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Shape_Kernel design optimisation | Hard | Planned |
| Multi-physics shape_kernel coupling | Expert | Planned (Level 4) |
