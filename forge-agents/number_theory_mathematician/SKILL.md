# Number Theory Mathematician — SKILL Definition

**Agent ID:** `number_theory_mathematician`
**Domain:** Number Theory — Primes, Modular Arithmetic, Cryptographic Number Theory
...
The Number Theory Mathematician performs number theory analysis, synthesising results
...
|---|---|---|
| Core number theory analysis (analytical) | Active (MVP) | Level 1 capability |
| Number Theory design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical number theory methods | Planned (V1) | Level 3 |
| Multi-physics number theory coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain number theory optimisation | Planned (V3) | Level 5 Master |
...
Every Number Theory Mathematician output MUST include:
...
6. `number_theory_summary` — structured domain summary (see Output Contract)
...
Raise **[NUMBER THEORY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core number theory analysis — analytical methods |
...
- **Regime violation**: applying number theory method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "number theory Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "number_theory_mathematician"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for number theory
