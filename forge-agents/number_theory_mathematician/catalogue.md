# Number Theory Mathematician — Capability Catalogue
...
The Number Theory Mathematician performs number theory analysis at Level 1
...
|---|---|---|
| Basic number theory sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Number Theory design optimisation | Hard | Planned |
| Multi-physics number theory coupling | Expert | Planned (Level 4) |
