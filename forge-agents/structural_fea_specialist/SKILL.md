# Structural Fea Specialist — SKILL Definition

**Agent ID:** `structural_fea_specialist`
**Domain:** Structural FEA — Finite Element Analysis, Mesh Quality, Solvers
...
The Structural Fea Specialist performs structural fea analysis, synthesising results
...
Every Structural Fea Specialist output MUST include:
...
peer_review_verdict:
  target_agent_id: "structural_fea_specialist"
  target_run_id: "..."
