# Structural Fea Specialist — Capability Catalogue

**Agent ID:** `structural_fea_specialist`
**Role:** Specialist
**Domain:** Structural FEA — Finite Element Analysis, Linear/Nonlinear
...
The Structural Fea Specialist performs structural fea analysis at Level 1
...
|---|---|---|
| Basic structural fea sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Structural Fea design optimisation | Hard | Planned |
| Multi-physics structural fea coupling | Expert | Planned (Level 4) |
