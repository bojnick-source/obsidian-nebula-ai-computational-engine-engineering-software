# System Decomposition — SKILL Definition

**Agent ID:** `system_decomposition`
**Domain:** System Decomposition — Architecture Analysis, Subsystem Breakdown
...
The System Decomposition performs system decomposition analysis, synthesising results
...
|---|---|---|
| Core system decomposition analysis (analytical) | Active (MVP) | Level 1 capability |
| System Decomposition design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical system decomposition methods | Planned (V1) | Level 3 |
| Multi-physics system decomposition coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain system decomposition optimisation | Planned (V3) | Level 5 Master |
...
Every System Decomposition output MUST include:
...
6. `system_decomposition_summary` — structured domain summary (see Output Contract)
...
Raise **[SYSTEM DECOMPOSITION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core system decomposition analysis — analytical methods |
...
- **Regime violation**: applying system decomposition method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "system decomposition Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "system_decomposition"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for system decomposition
