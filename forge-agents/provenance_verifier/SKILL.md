# Provenance Verifier — SKILL Definition

**Agent ID:** `provenance_verifier`
**Domain:** Provenance Verifier — Source specificity, tool version, input hash gate
...
The Provenance Verifier performs provenance verifier analysis, synthesising results
...
|---|---|---|
| Core provenance verifier analysis (analytical) | Active (MVP) | Level 1 capability |
| Provenance Verifier design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical provenance verifier methods | Planned (V1) | Level 3 |
| Multi-physics provenance verifier coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain provenance verifier optimisation | Planned (V3) | Level 5 Master |
...
Every Provenance Verifier output MUST include:
...
6. `provenance_verifier_summary` — structured domain summary (see Output Contract)
...
Raise **[PROVENANCE VERIFIER SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core provenance verifier analysis — analytical methods |
...
- **Regime violation**: applying provenance verifier method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Provenance Verifier Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "provenance_verifier"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for provenance verifier
