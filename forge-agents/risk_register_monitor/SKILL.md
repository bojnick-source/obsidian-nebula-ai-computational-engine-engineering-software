# Risk Register Monitor — SKILL Definition

**Agent ID:** `risk_register_monitor`
**Domain:** Risk Register Monitor — RISK_REGISTER.md staleness, open risk review scheduling
...
The Risk Register Monitor performs risk register monitor analysis, synthesising results
...
|---|---|---|
| Core risk register monitor analysis (analytical) | Active (MVP) | Level 1 capability |
| Risk Register Monitor design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical risk register monitor methods | Planned (V1) | Level 3 |
| Multi-physics risk register monitor coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain risk register monitor optimisation | Planned (V3) | Level 5 Master |
...
Every Risk Register Monitor output MUST include:
...
6. `risk_register_monitor_summary` — structured domain summary (see Output Contract)
...
Raise **[RISK REGISTER MONITOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core risk register monitor analysis — analytical methods |
...
- **Regime violation**: applying risk register monitor method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Risk Register Monitor Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "risk_register_monitor"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for risk register monitor
