...
**Domain:** Prompt Engineering — LLM Optimization, Agent Prompt Design
...
The Prompt Engineer performs prompt engineering analysis, synthesising results
...
|---|---|---|
| Core prompt engineering analysis (analytical) | Active (MVP) | Level 1 capability |
| Prompt Engineering design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical prompt engineering methods | Planned (V1) | Level 3 |
| Multi-physics prompt engineering coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain prompt engineering optimisation | Planned (V3) | Level 5 Master |
...
Every Prompt Engineer output MUST include:
...
6. `prompt_engineering_summary` — structured domain summary (see Output Contract)
...
Raise **[PROMPT ENGINEERING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core prompt engineering analysis — analytical methods |
...
- **Regime violation**: applying prompt engineering method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "prompt engineering Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "prompt_engineer"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for prompt engineering
