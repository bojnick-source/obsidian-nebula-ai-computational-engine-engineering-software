# Rover Wheel Antagonist — Capability Catalogue
...
The Rover Wheel Antagonist performs rigorous domain-specific critique of
`rover_wheel_specialist` outputs.
...
|---|---|---|
| Critique an analytical rover_wheel_critique output | Medium | Planned |
