# Mujoco Simulation Specialist — Capability Catalogue
...
The Mujoco Simulation Specialist performs mujoco_sim analysis at Level 1
...
|---|---|---|
| Basic mujoco_sim sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Mujoco_Sim design optimisation | Hard | Planned |
| Multi-physics mujoco_sim coupling | Expert | Planned (Level 4) |
