# Magnetics Em Fields Specialist — SKILL Definition

**Agent ID:** `magnetics_em_fields_specialist`
**Domain:** Magnetics & EM Fields — Flux, Permeability, Reluctance, Inductance, Eddy Currents
...
The Magnetics Em Fields Specialist performs magnetics & em fields analysis, synthesising results
...
|---|---|---|
| Core magnetics & em fields analysis (analytical) | Active (MVP) | Level 1 capability |
| Magnetics & Em Fields design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical magnetics & em fields methods | Planned (V1) | Level 3 |
| Multi-physics magnetics & em fields coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain magnetics & em fields optimisation | Planned (V3) | Level 5 Master |
...
Every Magnetics Em Fields Specialist output MUST include:
...
6. `magnetics_&_em_fields_summary` — structured domain summary (see Output Contract)
...
Raise **[MAGNETICS & EM FIELDS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core magnetics & em fields analysis — analytical methods |
...
- **Regime violation**: applying magnetics & em fields method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Magnetics & EM Fields Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "magnetics_em_fields_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for magnetics & em fields
