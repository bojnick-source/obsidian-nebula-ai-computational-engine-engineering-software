# Me Specialist — Capability Catalogue

**Agent ID:** `me_specialist`
**Role:** Specialist
**Domain:** Mechanical Engineering — Structural, Thermal, Manufacturing
...
The Me Specialist performs mechanical engineering analysis at Level 1
...
|---|---|---|
| Basic mechanical engineering sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Mechanical Engineering design optimisation | Hard | Planned |
| Multi-physics mechanical engineering coupling | Expert | Planned (Level 4) |
