# Fasteners Joints Specialist — SKILL Definition

**Agent ID:** `fasteners_joints_specialist`
**Domain:** Fasteners & Joints — Bolted Joints, Welds, Adhesives, Preload
...
The Fasteners Joints Specialist performs fasteners & joints analysis, synthesising results
...
|---|---|---|
| Core fasteners & joints analysis (analytical) | Active (MVP) | Level 1 capability |
| Fasteners & Joints design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical fasteners & joints methods | Planned (V1) | Level 3 |
| Multi-physics fasteners & joints coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain fasteners & joints optimisation | Planned (V3) | Level 5 Master |
...
Every Fasteners Joints Specialist output MUST include:
...
6. `fasteners_&_joints_summary` — structured domain summary (see Output Contract)
...
Raise **[FASTENERS & JOINTS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core fasteners & joints analysis — analytical methods |
...
- **Regime violation**: applying fasteners & joints method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Fasteners & Joints Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "fasteners_joints_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for fasteners & joints
