# Rotor Bemt Specialist — SKILL Definition

**Agent ID:** `rotor_bemt_specialist`
**Domain:** Rotor BEMT — Blade Element Momentum Theory, Hover & Forward Flight, Tip Loss
...
The Rotor Bemt Specialist performs rotor bemt analysis, synthesising results
...
|---|---|---|
| Core rotor bemt analysis (analytical) | Active (MVP) | Level 1 capability |
| Rotor Bemt design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical rotor bemt methods | Planned (V1) | Level 3 |
| Multi-physics rotor bemt coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain rotor bemt optimisation | Planned (V3) | Level 5 Master |
...
Every Rotor Bemt Specialist output MUST include:
...
6. `rotor_bemt_summary` — structured domain summary (see Output Contract)
...
Raise **[ROTOR BEMT SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core rotor bemt analysis — analytical methods |
...
- **Regime violation**: applying rotor bemt method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Rotor BEMT Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "rotor_bemt_specialist"
  target_run_id: "..."
