# Shape Kernel Antagonist — Capability Catalogue
...
The Shape Kernel Antagonist performs rigorous domain-specific critique of
`shape_kernel_specialist` outputs.
...
|---|---|---|
| Critique an analytical shape_kernel_critique output | Medium | Planned |
