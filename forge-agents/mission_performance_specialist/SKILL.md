# Mission Performance Specialist — SKILL Definition

**Agent ID:** `mission_performance_specialist`
**Domain:** Mission Performance — Range, Endurance, Payload, Speed, Ceiling, Hover Efficiency
...
The Mission Performance Specialist performs mission performance analysis, synthesising results
...
|---|---|---|
| Core mission performance analysis (analytical) | Active (MVP) | Level 1 capability |
| Mission Performance design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical mission performance methods | Planned (V1) | Level 3 |
| Multi-physics mission performance coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain mission performance optimisation | Planned (V3) | Level 5 Master |
...
Every Mission Performance Specialist output MUST include:
...
6. `mission_performance_summary` — structured domain summary (see Output Contract)
...
Raise **[MISSION PERFORMANCE SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core mission performance analysis — analytical methods |
...
- **Regime violation**: applying mission performance method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Mission Performance Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "mission_performance_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for mission performance
