# Sensor Fusion Specialist — SKILL Definition

**Agent ID:** `sensor_fusion_specialist`
**Domain:** Sensor Fusion — Kalman Filter, EKF, UKF, Complementary Filter, Observability
...
The Sensor Fusion Specialist performs sensor fusion analysis, synthesising results
...
|---|---|---|
| Core sensor fusion analysis (analytical) | Active (MVP) | Level 1 capability |
| Sensor Fusion design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical sensor fusion methods | Planned (V1) | Level 3 |
| Multi-physics sensor fusion coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain sensor fusion optimisation | Planned (V3) | Level 5 Master |
...
Every Sensor Fusion Specialist output MUST include:
...
6. `sensor_fusion_summary` — structured domain summary (see Output Contract)
...
Raise **[SENSOR FUSION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core sensor fusion analysis — analytical methods |
...
- **Regime violation**: applying sensor fusion method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Sensor Fusion Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "sensor_fusion_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for sensor fusion
