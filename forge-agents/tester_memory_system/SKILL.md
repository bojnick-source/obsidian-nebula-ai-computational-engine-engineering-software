# Tester Memory System — SKILL Definition

**Agent ID:** `tester_memory_system`
**Domain:** Tester — Memory System — Vault read/write, strategy retrieval, tool_prefs load
...
The Tester Memory System performs tester memory system analysis, synthesising results
...
|---|---|---|
| Core tester memory system analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Memory System design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester memory system methods | Planned (V1) | Level 3 |
| Multi-physics tester memory system coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester memory system optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Memory System output MUST include:
...
6. `tester_memory_system_summary` — structured domain summary (see Output Contract)
...
Raise **[TESTER MEMORY SYSTEM SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester memory system analysis — analytical methods |
...
- **Regime violation**: applying tester memory system method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Memory System Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_memory_system"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester memory system
