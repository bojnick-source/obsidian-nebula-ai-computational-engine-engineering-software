# Chemical Process Specialist — Capability Catalogue

**Agent ID:** `chemical_process_specialist`
**Role:** Specialist
**Domain:** Chemical Process Engineering — Reaction Engineering, Mass Transfer, Thermodynamics
...
The Chemical Process Specialist performs chemical process analysis at Level 1
...
|---|---|---|
| Basic chemical process sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Chemical Process design optimisation | Hard | Planned |
| Multi-physics chemical process coupling | Expert | Planned (Level 4) |
