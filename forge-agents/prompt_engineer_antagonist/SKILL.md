# Prompt Engineer Antagonist — SKILL Definition

**Agent ID:** `prompt_engineer_antagonist`
**Domain:** Prompt Engineer Critique — Prompt quality, injection risk, instruction clarity
...
The Prompt Engineer Antagonist is the domain-specialised critic for `prompt_engineer` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every prompt engineering failure mode by name |
...
|---|---|---|
| Full-output critique (prompt engineering domain) | Active (MVP) | Core capability |
...
Every Prompt Engineer Antagonist output MUST include:
...
Attack prompt engineering outputs in this priority order:
