# Tester Ops Observability — SKILL Definition

**Agent ID:** `tester_ops_observability`
**Domain:** Tester — Ops & Observability — Metrics emission, log format, alert routing
...
The Tester Ops Observability performs tester ops & observability analysis, synthesising results
...
|---|---|---|
| Core tester ops & observability analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Ops & Observability design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester ops & observability methods | Planned (V1) | Level 3 |
| Multi-physics tester ops & observability coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester ops & observability optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Ops Observability output MUST include:
...
6. `tester_ops_&_observability_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
tester_ops_&_observability_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[TESTER OPS & OBSERVABILITY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester ops & observability analysis — analytical methods |
...
- **Regime violation**: applying tester ops & observability method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Ops & Observability Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_ops_observability"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester ops & observability
