# Cad Parametric Modeling Specialist — SKILL Definition

**Agent ID:** `cad_parametric_modeling_specialist`
**Domain:** CAD & Parametric Modelling — Feature Trees, Parametric Families, OCCT, STEP
...
The Cad Parametric Modeling Specialist performs cad & parametric modelling analysis, synthesising results
...
|---|---|---|
| Core cad & parametric modelling analysis (analytical) | Active (MVP) | Level 1 capability |
| Cad & Parametric Modelling design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical cad & parametric modelling methods | Planned (V1) | Level 3 |
| Multi-physics cad & parametric modelling coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain cad & parametric modelling optimisation | Planned (V3) | Level 5 Master |
...
Every Cad Parametric Modeling Specialist output MUST include:
...
6. `cad_&_parametric_modelling_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
cad_&_parametric_modelling_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[CAD & PARAMETRIC MODELLING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core cad & parametric modelling analysis — analytical methods |
...
- **Regime violation**: applying cad & parametric modelling method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "CAD & Parametric Modelling Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "cad_parametric_modeling_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for cad & parametric modelling
