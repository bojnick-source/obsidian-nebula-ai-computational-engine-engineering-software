# Mcp Tooling Specialist — SKILL Definition

**Agent ID:** `mcp_tooling_specialist`
**Domain:** MCP Tooling — MCP Server Design, Tool Registration, Schema, Transport, Auth
...
The Mcp Tooling Specialist performs mcp tooling analysis, synthesising results
...
|---|---|---|
| Core mcp tooling analysis (analytical) | Active (MVP) | Level 1 capability |
| Mcp Tooling design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical mcp tooling methods | Planned (V1) | Level 3 |
| Multi-physics mcp tooling coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain mcp tooling optimisation | Planned (V3) | Level 5 Master |
...
Every Mcp Tooling Specialist output MUST include:
...
6. `mcp_tooling_summary` — structured domain summary (see Output Contract)
...
Raise **[MCP TOOLING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core mcp tooling analysis — analytical methods |
...
- **Regime violation**: applying mcp tooling method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "MCP Tooling Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "mcp_tooling_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for mcp tooling
