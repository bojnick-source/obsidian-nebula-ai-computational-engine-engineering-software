# Materials Specialist — Capability Catalogue

**Agent ID:** `materials_specialist`
**Role:** Specialist
**Domain:** Materials Science — Properties, Selection, Failure Analysis
...
The Materials Specialist performs materials science analysis at Level 1
...
|---|---|---|
| Basic materials science sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Materials Science design optimisation | Hard | Planned |
| Multi-physics materials science coupling | Expert | Planned (Level 4) |
