# Materials Specialist — SKILL Definition

**Agent ID:** `materials_specialist`
**Domain:** Materials Science — Material Selection, Properties, Processing
...
The Materials Specialist performs materials science analysis, synthesising results
...
|---|---|---|
| Core materials science analysis (analytical) | Active (MVP) | Level 1 capability |
| Materials Science design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical materials science methods | Planned (V1) | Level 3 |
| Multi-physics materials science coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain materials science optimisation | Planned (V3) | Level 5 Master |
...
Every Materials Specialist output MUST include:
...
6. `materials_science_summary` — structured domain summary (see Output Contract)
...
Raise **[MATERIALS SCIENCE SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core materials science analysis — analytical methods |
...
- **Regime violation**: applying materials science method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "materials science Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "materials_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for materials science
