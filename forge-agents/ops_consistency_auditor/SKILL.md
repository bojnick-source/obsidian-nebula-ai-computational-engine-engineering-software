# Ops Consistency Auditor — SKILL Definition

**Agent ID:** `ops_consistency_auditor`
**Domain:** Ops Consistency Auditor — Cross-system config consistency, IaC drift detection
...
The Ops Consistency Auditor performs ops consistency auditor analysis, synthesising results
...
|---|---|---|
| Core ops consistency auditor analysis (analytical) | Active (MVP) | Level 1 capability |
| Ops Consistency Auditor design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical ops consistency auditor methods | Planned (V1) | Level 3 |
| Multi-physics ops consistency auditor coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain ops consistency auditor optimisation | Planned (V3) | Level 5 Master |
...
Every Ops Consistency Auditor output MUST include:
...
6. `ops_consistency_auditor_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
ops_consistency_auditor_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[OPS CONSISTENCY AUDITOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core ops consistency auditor analysis — analytical methods |
...
- **Regime violation**: applying ops consistency auditor method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Ops Consistency Auditor Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "ops_consistency_auditor"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for ops consistency auditor
