# Optimization Bayesian Specialist — SKILL Definition

**Agent ID:** `optimization_bayesian_specialist`
**Domain:** Bayesian Optimisation — BO, Gaussian Process Surrogate, Acquisition Functions, EI
...
The Optimization Bayesian Specialist performs bayesian optimisation analysis, synthesising results
...
|---|---|---|
| Core bayesian optimisation analysis (analytical) | Active (MVP) | Level 1 capability |
| Bayesian Optimisation design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical bayesian optimisation methods | Planned (V1) | Level 3 |
| Multi-physics bayesian optimisation coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain bayesian optimisation optimisation | Planned (V3) | Level 5 Master |
...
Every Optimization Bayesian Specialist output MUST include:
...
6. `bayesian_optimisation_summary` — structured domain summary (see Output Contract)
...
Raise **[BAYESIAN OPTIMISATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core bayesian optimisation analysis — analytical methods |
...
- **Regime violation**: applying bayesian optimisation method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Bayesian Optimisation Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "optimization_bayesian_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for bayesian optimisation
