# Emi Emc Specialist — SKILL Definition

**Agent ID:** `emi_emc_specialist`
**Domain:** EMI/EMC — Radiated/Conducted Emissions, Shielding, Filtering, DO-160/MIL-STD-461
...
The Emi Emc Specialist performs emi/emc analysis, synthesising results
...
|---|---|---|
| Core emi/emc analysis (analytical) | Active (MVP) | Level 1 capability |
| Emi/Emc design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical emi/emc methods | Planned (V1) | Level 3 |
| Multi-physics emi/emc coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain emi/emc optimisation | Planned (V3) | Level 5 Master |
...
Every Emi Emc Specialist output MUST include:
...
6. `emi/emc_summary` — structured domain summary (see Output Contract)
...
Raise **[EMI/EMC SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core emi/emc analysis — analytical methods |
...
- **Regime violation**: applying emi/emc method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "EMI/EMC Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "emi_emc_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for emi/emc
