# Robotics Specialist — Capability Catalogue
...
The Robotics Specialist performs robotics analysis at Level 1
...
|---|---|---|
| Basic robotics sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Robotics design optimisation | Hard | Planned |
| Multi-physics robotics coupling | Expert | Planned (Level 4) |
