# Reliability Engineering Specialist — SKILL Definition

**Agent ID:** `reliability_engineering_specialist`
**Domain:** Reliability Engineering — MTBF, FTA, RBD, FMEA, Reliability Allocation, MIL-HDBK-217
...
The Reliability Engineering Specialist performs reliability engineering analysis, synthesising results
...
|---|---|---|
| Core reliability engineering analysis (analytical) | Active (MVP) | Level 1 capability |
| Reliability Engineering design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical reliability engineering methods | Planned (V1) | Level 3 |
| Multi-physics reliability engineering coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain reliability engineering optimisation | Planned (V3) | Level 5 Master |
...
Every Reliability Engineering Specialist output MUST include:
...
6. `reliability_engineering_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
reliability_engineering_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[RELIABILITY ENGINEERING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core reliability engineering analysis — analytical methods |
...
- **Regime violation**: applying reliability engineering method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Reliability Engineering Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "reliability_engineering_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for reliability engineering
