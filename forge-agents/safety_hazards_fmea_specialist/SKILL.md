# Safety Hazards Fmea Specialist — SKILL Definition

**Agent ID:** `safety_hazards_fmea_specialist`
**Domain:** Safety, Hazards & FMEA — Hazard Analysis, FMEA/FMECA, FTA, DAL, ARP4761
...
The Safety Hazards Fmea Specialist performs safety, hazards & fmea analysis, synthesising results
...
|---|---|---|
| Core safety, hazards & fmea analysis (analytical) | Active (MVP) | Level 1 capability |
| Safety, Hazards & Fmea design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical safety, hazards & fmea methods | Planned (V1) | Level 3 |
| Multi-physics safety, hazards & fmea coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain safety, hazards & fmea optimisation | Planned (V3) | Level 5 Master |
...
Every Safety Hazards Fmea Specialist output MUST include:
...
6. `safety,_hazards_&_fmea_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
safety,_hazards_&_fmea_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[SAFETY, HAZARDS & FMEA SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core safety, hazards & fmea analysis — analytical methods |
...
- **Regime violation**: applying safety, hazards & fmea method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Safety, Hazards & FMEA Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "safety_hazards_fmea_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for safety, hazards & fmea
