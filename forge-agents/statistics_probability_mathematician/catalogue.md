# Statistics Probability Mathematician — Capability Catalogue

**Agent ID:** `statistics_probability_mathematician`
**Role:** Specialist
**Domain:** Statistics and Probability — Bayesian Inference, Distributions, Hypothesis Testing
...
The Statistics Probability Mathematician performs statistics and probability analysis at Level 1
...
|---|---|---|
| Basic statistics and probability sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Statistics And Probability design optimisation | Hard | Planned |
| Multi-physics statistics and probability coupling | Expert | Planned (Level 4) |
