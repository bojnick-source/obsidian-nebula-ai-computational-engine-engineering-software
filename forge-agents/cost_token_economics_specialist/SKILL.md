# Cost Token Economics Specialist — SKILL Definition

**Agent ID:** `cost_token_economics_specialist`
**Domain:** Cost & Token Economics — Token Budgets, API Cost Modelling, Run Economics, ROI
...
The Cost Token Economics Specialist performs cost & token economics analysis, synthesising results
...
|---|---|---|
| Core cost & token economics analysis (analytical) | Active (MVP) | Level 1 capability |
| Cost & Token Economics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical cost & token economics methods | Planned (V1) | Level 3 |
| Multi-physics cost & token economics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain cost & token economics optimisation | Planned (V3) | Level 5 Master |
...
Every Cost Token Economics Specialist output MUST include:
...
6. `cost_&_token_economics_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
cost_&_token_economics_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[COST & TOKEN ECONOMICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core cost & token economics analysis — analytical methods |
...
- **Regime violation**: applying cost & token economics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Cost & Token Economics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "cost_token_economics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for cost & token economics
