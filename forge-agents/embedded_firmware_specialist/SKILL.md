# Embedded Firmware Specialist — SKILL Definition

**Agent ID:** `embedded_firmware_specialist`
**Domain:** Embedded Firmware — MCU, RTOS, HAL, Drivers, Bootloader, OTA Updates
...
The Embedded Firmware Specialist performs embedded firmware analysis, synthesising results
...
|---|---|---|
| Core embedded firmware analysis (analytical) | Active (MVP) | Level 1 capability |
| Embedded Firmware design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical embedded firmware methods | Planned (V1) | Level 3 |
| Multi-physics embedded firmware coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain embedded firmware optimisation | Planned (V3) | Level 5 Master |
...
Every Embedded Firmware Specialist output MUST include:
...
6. `embedded_firmware_summary` — structured domain summary (see Output Contract)
...
Raise **[EMBEDDED FIRMWARE SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core embedded firmware analysis — analytical methods |
...
- **Regime violation**: applying embedded firmware method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Embedded Firmware Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "embedded_firmware_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for embedded firmware
