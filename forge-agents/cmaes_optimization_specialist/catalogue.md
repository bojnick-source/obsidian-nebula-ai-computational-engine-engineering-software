# Cmaes Optimization Specialist — Capability Catalogue
...
The Cmaes Optimization Specialist performs cmaes_opt analysis at Level 1
...
|---|---|---|
| Basic cmaes_opt sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Cmaes_Opt design optimisation | Hard | Planned |
| Multi-physics cmaes_opt coupling | Expert | Planned (Level 4) |
