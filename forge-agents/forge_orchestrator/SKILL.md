# Forge Orchestrator — SKILL Definition

**Agent ID:** `forge_orchestrator`
**Domain:** FORGE Orchestrator — Top-level workflow routing, agent spawning, task decomposition
...
The Forge Orchestrator performs forge orchestrator analysis, synthesising results
...
|---|---|---|
| Core forge orchestrator analysis (analytical) | Active (MVP) | Level 1 capability |
| Forge Orchestrator design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical forge orchestrator methods | Planned (V1) | Level 3 |
| Multi-physics forge orchestrator coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain forge orchestrator optimisation | Planned (V3) | Level 5 Master |
...
Every Forge Orchestrator output MUST include:
...
6. `forge_orchestrator_summary` — structured domain summary (see Output Contract)
...
Raise **[FORGE ORCHESTRATOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core forge orchestrator analysis — analytical methods |
...
- **Regime violation**: applying forge orchestrator method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "FORGE Orchestrator Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "forge_orchestrator"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for forge orchestrator
