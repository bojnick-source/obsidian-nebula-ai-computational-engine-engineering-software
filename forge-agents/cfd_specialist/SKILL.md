# Cfd Specialist — SKILL Definition

**Agent ID:** `cfd_specialist`
**Domain:** CFD — Mesh Quality, Solver Selection, Turbulence Models, Convergence
...
The Cfd Specialist performs cfd analysis, synthesising results
...
|---|---|---|
| Core cfd analysis (analytical) | Active (MVP) | Level 1 capability |
| Cfd design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical cfd methods | Planned (V1) | Level 3 |
| Multi-physics cfd coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain cfd optimisation | Planned (V3) | Level 5 Master |
...
Every Cfd Specialist output MUST include:
...
6. `cfd_summary` — structured domain summary (see Output Contract)
...
Raise **[CFD SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core cfd analysis — analytical methods |
...
- **Regime violation**: applying cfd method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "CFD Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "cfd_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for cfd
