# Safety Se Specialist — SKILL Definition

**Agent ID:** `safety_se_specialist`
**Domain:** Safety & Systems Engineering — FMEA, FTA, Hazard Analysis
...
The Safety Se Specialist performs safety analysis analysis, synthesising results
...
|---|---|---|
| Core safety analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Safety Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical safety analysis methods | Planned (V1) | Level 3 |
| Multi-physics safety analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain safety analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Safety Se Specialist output MUST include:
...
6. `safety_analysis_summary` — structured domain summary (see Output Contract)
...
Raise **[SAFETY ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core safety analysis analysis — analytical methods |
...
- **Regime violation**: applying safety analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "safety analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "safety_se_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for safety analysis
