# Mujoco Simulation Antagonist — Capability Catalogue
...
The Mujoco Simulation Antagonist performs rigorous domain-specific critique of
`mujoco_simulation_specialist` outputs.
...
|---|---|---|
| Critique an analytical mujoco_sim output | Medium | Planned |
