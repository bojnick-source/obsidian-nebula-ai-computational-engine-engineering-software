# Electric Machines Antagonist — SKILL Definition

**Agent ID:** `electric_machines_antagonist`
**Domain:** Electric Machines Critique
...
The Electric Machines Antagonist is the domain-specialised critic for `electric_machines_specialist` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every electric machines failure mode by name |
...
|---|---|---|
| Full-output critique (electric machines domain) | Active (MVP) | Core capability |
...
Every Electric Machines Antagonist output MUST include:
...
Attack electric machines outputs in this priority order:
