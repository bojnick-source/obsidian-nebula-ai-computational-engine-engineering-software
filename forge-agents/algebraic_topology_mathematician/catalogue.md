# Algebraic Topology Mathematician — Capability Catalogue
...
The Algebraic Topology Mathematician performs algebraic topology analysis at Level 1
...
|---|---|---|
| Basic algebraic topology sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Algebraic Topology design optimisation | Hard | Planned |
| Multi-physics algebraic topology coupling | Expert | Planned (Level 4) |
