# Simulation Toolchain Integration Specialist — SKILL Definition

**Agent ID:** `simulation_toolchain_integration_specialist`
**Domain:** Simulation Toolchain Integration — Co-Simulation, preCICE, Tool Coupling, Data Exchange
...
The Simulation Toolchain Integration Specialist performs simulation toolchain integration analysis, synthesising results
...
|---|---|---|
| Core simulation toolchain integration analysis (analytical) | Active (MVP) | Level 1 capability |
| Simulation Toolchain Integration design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical simulation toolchain integration methods | Planned (V1) | Level 3 |
| Multi-physics simulation toolchain integration coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain simulation toolchain integration optimisation | Planned (V3) | Level 5 Master |
...
Every Simulation Toolchain Integration Specialist output MUST include:
...
6. `simulation_toolchain_integration_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
simulation_toolchain_integration_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[SIMULATION TOOLCHAIN INTEGRATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core simulation toolchain integration analysis — analytical methods |
...
- **Regime violation**: applying simulation toolchain integration method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Simulation Toolchain Integration Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "simulation_toolchain_integration_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for simulation toolchain integration
