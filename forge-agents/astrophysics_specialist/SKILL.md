# Astrophysics Specialist — SKILL Definition

**Agent ID:** `astrophysics_specialist`
**Domain:** Astrophysics — Orbital Mechanics, Stellar Structure, Cosmology
...
The Astrophysics Specialist performs astrophysics analysis, synthesising results
...
|---|---|---|
| Core astrophysics analysis (analytical) | Active (MVP) | Level 1 capability |
| Astrophysics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical astrophysics methods | Planned (V1) | Level 3 |
| Multi-physics astrophysics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain astrophysics optimisation | Planned (V3) | Level 5 Master |
...
Every Astrophysics Specialist output MUST include:
...
6. `astrophysics_summary` — structured domain summary (see Output Contract)
...
Raise **[ASTROPHYSICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core astrophysics analysis — analytical methods |
...
- **Regime violation**: applying astrophysics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "astrophysics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "astrophysics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for astrophysics
