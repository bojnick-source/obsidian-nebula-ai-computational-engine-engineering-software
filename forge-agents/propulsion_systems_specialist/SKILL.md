# Propulsion Systems Specialist — SKILL Definition

**Agent ID:** `propulsion_systems_specialist`
**Domain:** Propulsion Systems — Jets, Rockets, Electric Propulsion, Thrust-to-Weight
...
The Propulsion Systems Specialist performs propulsion systems analysis, synthesising results
...
|---|---|---|
| Core propulsion systems analysis (analytical) | Active (MVP) | Level 1 capability |
| Propulsion Systems design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical propulsion systems methods | Planned (V1) | Level 3 |
| Multi-physics propulsion systems coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain propulsion systems optimisation | Planned (V3) | Level 5 Master |
...
Every Propulsion Systems Specialist output MUST include:
...
6. `propulsion_systems_summary` — structured domain summary (see Output Contract)
...
Raise **[PROPULSION SYSTEMS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core propulsion systems analysis — analytical methods |
...
- **Regime violation**: applying propulsion systems method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Propulsion Systems Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "propulsion_systems_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for propulsion systems
