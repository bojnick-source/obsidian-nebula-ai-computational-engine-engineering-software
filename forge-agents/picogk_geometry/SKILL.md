...
**Domain:** PicoGK Geometry — Voxel-Based Geometry, Lattice Infill
...
The Picogk Geometry performs picogk geometry analysis, synthesising results
...
|---|---|---|
| Core picogk geometry analysis (analytical) | Active (MVP) | Level 1 capability |
| Picogk Geometry design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical picogk geometry methods | Planned (V1) | Level 3 |
| Multi-physics picogk geometry coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain picogk geometry optimisation | Planned (V3) | Level 5 Master |
...
6. `picogk_geometry_summary` — structured domain summary (see Output Contract)
...
Raise **[PICOGK GEOMETRY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core picogk geometry analysis — analytical methods |
...
- **Regime violation**: applying picogk geometry method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "picogk geometry Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "picogk_geometry"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for picogk geometry
