# Tester Maintenance Mesh — SKILL Definition

**Agent ID:** `tester_maintenance_mesh`
**Domain:** Tester — Maintenance Mesh — Schema audits, drift detection, fixture integrity
...
The Tester Maintenance Mesh performs tester maintenance mesh analysis, synthesising results
...
|---|---|---|
| Core tester maintenance mesh analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Maintenance Mesh design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester maintenance mesh methods | Planned (V1) | Level 3 |
| Multi-physics tester maintenance mesh coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester maintenance mesh optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Maintenance Mesh output MUST include:
...
6. `tester_maintenance_mesh_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
tester_maintenance_mesh_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[TESTER MAINTENANCE MESH SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester maintenance mesh analysis — analytical methods |
...
- **Regime violation**: applying tester maintenance mesh method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester Maintenance Mesh Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_maintenance_mesh"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester maintenance mesh
