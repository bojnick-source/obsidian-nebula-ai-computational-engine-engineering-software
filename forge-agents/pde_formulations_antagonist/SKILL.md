# Pde Formulations Antagonist — SKILL Definition

**Agent ID:** `pde_formulations_antagonist`
**Domain:** PDE Formulations Critique
...
The Pde Formulations Antagonist is the domain-specialised critic for `pde_formulations_specialist` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every pde formulations failure mode by name |
...
|---|---|---|
| Full-output critique (pde formulations domain) | Active (MVP) | Core capability |
...
Every Pde Formulations Antagonist output MUST include:
...
Attack pde formulations outputs in this priority order:
