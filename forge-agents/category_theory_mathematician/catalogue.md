# Category Theory Mathematician — Capability Catalogue
...
The Category Theory Mathematician performs category theory analysis at Level 1
...
|---|---|---|
| Basic category theory sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Category Theory design optimisation | Hard | Planned |
| Multi-physics category theory coupling | Expert | Planned (Level 4) |
