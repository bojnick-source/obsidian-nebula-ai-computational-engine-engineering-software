# Category Theory Mathematician — SKILL Definition

**Agent ID:** `category_theory_mathematician`
**Domain:** Category Theory — Functors, Natural Transformations, Monads
...
The Category Theory Mathematician performs category theory analysis, synthesising results
...
|---|---|---|
| Core category theory analysis (analytical) | Active (MVP) | Level 1 capability |
| Category Theory design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical category theory methods | Planned (V1) | Level 3 |
| Multi-physics category theory coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain category theory optimisation | Planned (V3) | Level 5 Master |
...
Every Category Theory Mathematician output MUST include:
...
6. `category_theory_summary` — structured domain summary (see Output Contract)
...
Raise **[CATEGORY THEORY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core category theory analysis — analytical methods |
...
- **Regime violation**: applying category theory method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "category theory Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "category_theory_mathematician"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for category theory
