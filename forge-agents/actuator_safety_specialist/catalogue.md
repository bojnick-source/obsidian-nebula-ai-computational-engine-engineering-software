# Actuator Safety Specialist — Capability Catalogue
...
The Actuator Safety Specialist performs actuator_safety analysis at Level 1
...
|---|---|---|
| Basic actuator_safety sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Actuator_Safety design optimisation | Hard | Planned |
| Multi-physics actuator_safety coupling | Expert | Planned (Level 4) |
