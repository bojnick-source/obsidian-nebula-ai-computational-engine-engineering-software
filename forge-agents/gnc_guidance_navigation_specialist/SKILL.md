# Gnc Guidance Navigation Specialist — SKILL Definition

**Agent ID:** `gnc_guidance_navigation_specialist`
**Domain:** GNC — Guidance, Navigation, Trajectory Planning, Waypoints, Path Following
...
The Gnc Guidance Navigation Specialist performs gnc guidance & navigation analysis, synthesising results
...
|---|---|---|
| Core gnc guidance & navigation analysis (analytical) | Active (MVP) | Level 1 capability |
| Gnc Guidance & Navigation design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical gnc guidance & navigation methods | Planned (V1) | Level 3 |
| Multi-physics gnc guidance & navigation coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain gnc guidance & navigation optimisation | Planned (V3) | Level 5 Master |
...
Every Gnc Guidance Navigation Specialist output MUST include:
...
6. `gnc_guidance_&_navigation_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
gnc_guidance_&_navigation_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[GNC GUIDANCE & NAVIGATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core gnc guidance & navigation analysis — analytical methods |
...
- **Regime violation**: applying gnc guidance & navigation method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "GNC Guidance & Navigation Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "gnc_guidance_navigation_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for gnc guidance & navigation
