# Mathematical Logic Mathematician — SKILL Definition

**Agent ID:** `mathematical_logic_mathematician`
**Domain:** Mathematical Logic — Formal Systems, Proof Theory, Model Theory
...
The Mathematical Logic Mathematician performs mathematical logic analysis, synthesising results
...
|---|---|---|
| Core mathematical logic analysis (analytical) | Active (MVP) | Level 1 capability |
| Mathematical Logic design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical mathematical logic methods | Planned (V1) | Level 3 |
| Multi-physics mathematical logic coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain mathematical logic optimisation | Planned (V3) | Level 5 Master |
...
Every Mathematical Logic Mathematician output MUST include:
...
6. `mathematical_logic_summary` — structured domain summary (see Output Contract)
...
Raise **[MATHEMATICAL LOGIC SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core mathematical logic analysis — analytical methods |
...
- **Regime violation**: applying mathematical logic method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "mathematical logic Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "mathematical_logic_mathematician"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for mathematical logic
