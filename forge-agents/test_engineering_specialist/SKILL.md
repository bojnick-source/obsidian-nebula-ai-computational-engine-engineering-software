# Test Engineering Specialist — SKILL Definition

**Agent ID:** `test_engineering_specialist`
**Domain:** Test Engineering — Test Planning, Fixtures, Data Acquisition, Statistical Test Design
...
The Test Engineering Specialist performs test engineering analysis, synthesising results
...
|---|---|---|
| Core test engineering analysis (analytical) | Active (MVP) | Level 1 capability |
| Test Engineering design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical test engineering methods | Planned (V1) | Level 3 |
| Multi-physics test engineering coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain test engineering optimisation | Planned (V3) | Level 5 Master |
...
Every Test Engineering Specialist output MUST include:
...
6. `test_engineering_summary` — structured domain summary (see Output Contract)
...
Raise **[TEST ENGINEERING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core test engineering analysis — analytical methods |
...
- **Regime violation**: applying test engineering method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Test Engineering Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "test_engineering_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for test engineering
