# Data Engineering Logging Specialist — SKILL Definition

**Agent ID:** `data_engineering_logging_specialist`
**Domain:** Data Engineering & Logging — Logging Pipelines, Schemas, ETL, Retention, GDPR
...
The Data Engineering Logging Specialist performs data engineering & logging analysis, synthesising results
...
|---|---|---|
| Core data engineering & logging analysis (analytical) | Active (MVP) | Level 1 capability |
| Data Engineering & Logging design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical data engineering & logging methods | Planned (V1) | Level 3 |
| Multi-physics data engineering & logging coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain data engineering & logging optimisation | Planned (V3) | Level 5 Master |
...
Every Data Engineering Logging Specialist output MUST include:
...
6. `data_engineering_&_logging_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
data_engineering_&_logging_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[DATA ENGINEERING & LOGGING SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core data engineering & logging analysis — analytical methods |
...
- **Regime violation**: applying data engineering & logging method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Data Engineering & Logging Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "data_engineering_logging_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for data engineering & logging
