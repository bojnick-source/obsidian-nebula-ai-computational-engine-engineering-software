# Geophysics Specialist — SKILL Definition
...
The Geophysics Specialist performs geophysics analysis, synthesising results
...
|---|---|---|
| Core geophysics analysis (analytical) | Active (MVP) | Level 1 capability |
| Geophysics design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical geophysics methods | Planned (V1) | Level 3 |
| Multi-physics geophysics coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain geophysics optimisation | Planned (V3) | Level 5 Master |
...
Every Geophysics Specialist output MUST include:
...
6. `geophysics_summary` — structured domain summary (see Output Contract)
...
Raise **[GEOPHYSICS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core geophysics analysis — analytical methods |
...
- **Regime violation**: applying geophysics method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "geophysics Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "geophysics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for geophysics
