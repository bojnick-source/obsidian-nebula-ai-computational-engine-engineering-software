# Corrosion Degradation Specialist — SKILL Definition

**Agent ID:** `corrosion_degradation_specialist`
**Domain:** Corrosion & Degradation — Galvanic, SCC, Oxidation, Fatigue Corrosion, Coatings
...
The Corrosion Degradation Specialist performs corrosion & degradation analysis, synthesising results
...
|---|---|---|
| Core corrosion & degradation analysis (analytical) | Active (MVP) | Level 1 capability |
| Corrosion & Degradation design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical corrosion & degradation methods | Planned (V1) | Level 3 |
| Multi-physics corrosion & degradation coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain corrosion & degradation optimisation | Planned (V3) | Level 5 Master |
...
Every Corrosion Degradation Specialist output MUST include:
...
6. `corrosion_&_degradation_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
corrosion_&_degradation_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[CORROSION & DEGRADATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core corrosion & degradation analysis — analytical methods |
...
- **Regime violation**: applying corrosion & degradation method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Corrosion & Degradation Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "corrosion_degradation_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for corrosion & degradation
