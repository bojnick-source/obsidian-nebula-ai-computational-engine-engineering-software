# Dynamics Multibody Specialist — SKILL Definition

**Agent ID:** `dynamics_multibody_specialist`
**Domain:** Dynamics & Multibody — Rigid Body Dynamics, MBD, Transient Loads
...
The Dynamics Multibody Specialist performs dynamics & multibody analysis, synthesising results
...
|---|---|---|
| Core dynamics & multibody analysis (analytical) | Active (MVP) | Level 1 capability |
| Dynamics & Multibody design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical dynamics & multibody methods | Planned (V1) | Level 3 |
| Multi-physics dynamics & multibody coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain dynamics & multibody optimisation | Planned (V3) | Level 5 Master |
...
Every Dynamics Multibody Specialist output MUST include:
...
6. `dynamics_&_multibody_summary` — structured domain summary (see Output Contract)
...
Raise **[DYNAMICS & MULTIBODY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core dynamics & multibody analysis — analytical methods |
...
- **Regime violation**: applying dynamics & multibody method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Dynamics & Multibody Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "dynamics_multibody_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for dynamics & multibody
