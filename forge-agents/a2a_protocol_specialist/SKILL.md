# A2A Protocol Specialist — SKILL Definition

**Agent ID:** `a2a_protocol_specialist`
**Domain:** A2A Protocol — Agent-to-Agent Messaging, Task Routing, Blackboard, Contract Enforcement
...
The A2A Protocol Specialist performs a2a protocol analysis, synthesising results
...
|---|---|---|
| Core a2a protocol analysis (analytical) | Active (MVP) | Level 1 capability |
| A2A Protocol design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical a2a protocol methods | Planned (V1) | Level 3 |
| Multi-physics a2a protocol coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain a2a protocol optimisation | Planned (V3) | Level 5 Master |
...
Every A2A Protocol Specialist output MUST include:
...
6. `a2a_protocol_summary` — structured domain summary (see Output Contract)
...
Raise **[A2A PROTOCOL SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core a2a protocol analysis — analytical methods |
...
- **Regime violation**: applying a2a protocol method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "A2A Protocol Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "a2a_protocol_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for a2a protocol
