# Drift Monitor — SKILL Definition

**Agent ID:** `drift_monitor`
**Domain:** Drift Monitor — Registry vs filesystem drift detection, missing file alerting
...
The Drift Monitor performs drift monitor analysis, synthesising results
...
|---|---|---|
| Core drift monitor analysis (analytical) | Active (MVP) | Level 1 capability |
| Drift Monitor design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical drift monitor methods | Planned (V1) | Level 3 |
| Multi-physics drift monitor coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain drift monitor optimisation | Planned (V3) | Level 5 Master |
...
Every Drift Monitor output MUST include:
...
6. `drift_monitor_summary` — structured domain summary (see Output Contract)
...
Raise **[DRIFT MONITOR SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core drift monitor analysis — analytical methods |
...
- **Regime violation**: applying drift monitor method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Drift Monitor Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "drift_monitor"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for drift monitor
