# Synthmuscle Antagonist — Capability Catalogue
...
The Synthmuscle Antagonist performs rigorous domain-specific critique of
`synthmuscle_specialist` outputs.
...
|---|---|---|
| Critique an analytical synthmuscle output | Medium | Planned |
