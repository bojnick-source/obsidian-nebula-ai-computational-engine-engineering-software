# Tester Mcp Wrappers — SKILL Definition

**Agent ID:** `tester_mcp_wrappers`
**Domain:** Tester — MCP Wrappers — Tool invocation, schema validation, error codes
...
The Tester Mcp Wrappers performs tester mcp wrappers analysis, synthesising results
...
|---|---|---|
| Core tester mcp wrappers analysis (analytical) | Active (MVP) | Level 1 capability |
| Tester Mcp Wrappers design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical tester mcp wrappers methods | Planned (V1) | Level 3 |
| Multi-physics tester mcp wrappers coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain tester mcp wrappers optimisation | Planned (V3) | Level 5 Master |
...
Every Tester Mcp Wrappers output MUST include:
...
6. `tester_mcp_wrappers_summary` — structured domain summary (see Output Contract)
...
Raise **[TESTER MCP WRAPPERS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core tester mcp wrappers analysis — analytical methods |
...
- **Regime violation**: applying tester mcp wrappers method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Tester MCP Wrappers Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "tester_mcp_wrappers"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for tester mcp wrappers
