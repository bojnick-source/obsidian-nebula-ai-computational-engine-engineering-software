# Magnetics Specialist — SKILL Definition

**Agent ID:** `magnetics_specialist`
**Domain:** Magnetics — EM Fields, Core Design, Coil Geometry
...
The Magnetics Specialist performs magnetics analysis analysis, synthesising results
...
|---|---|---|
| Core magnetics analysis analysis (analytical) | Active (MVP) | Level 1 capability |
| Magnetics Analysis design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical magnetics analysis methods | Planned (V1) | Level 3 |
| Multi-physics magnetics analysis coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain magnetics analysis optimisation | Planned (V3) | Level 5 Master |
...
Every Magnetics Specialist output MUST include:
...
6. `magnetics_analysis_summary` — structured domain summary (see Output Contract)
...
Raise **[MAGNETICS ANALYSIS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core magnetics analysis analysis — analytical methods |
...
- **Regime violation**: applying magnetics analysis method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "magnetics analysis Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "magnetics_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for magnetics analysis
