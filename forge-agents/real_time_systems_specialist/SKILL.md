# Real Time Systems Specialist — SKILL Definition

**Agent ID:** `real_time_systems_specialist`
**Domain:** Real-Time Systems — RTOS Scheduling, WCET, Deadline Verification, Priority Inversion
...
The Real Time Systems Specialist performs real-time systems analysis, synthesising results
...
|---|---|---|
| Core real-time systems analysis (analytical) | Active (MVP) | Level 1 capability |
| Real-Time Systems design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical real-time systems methods | Planned (V1) | Level 3 |
| Multi-physics real-time systems coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain real-time systems optimisation | Planned (V3) | Level 5 Master |
...
Every Real Time Systems Specialist output MUST include:
...
6. `real_time_systems_summary` — structured domain summary (see Output Contract)
...
Raise **[REAL-TIME SYSTEMS SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core real-time systems analysis — analytical methods |
...
- **Regime violation**: applying real-time systems method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Real-Time Systems Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "real_time_systems_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for real-time systems
