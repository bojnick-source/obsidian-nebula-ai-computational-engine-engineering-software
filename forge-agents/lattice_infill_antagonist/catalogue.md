# Lattice Infill Antagonist — Capability Catalogue
...
The Lattice Infill Antagonist performs rigorous domain-specific critique of
`lattice_infill_specialist` outputs.
...
|---|---|---|
| Critique an analytical lattice_infill_critique output | Medium | Planned |
