# Verification Validation Specialist — SKILL Definition

**Agent ID:** `verification_validation_specialist`
**Domain:** Verification & Validation — V&V Plans, Test Procedures, Acceptance Criteria, DO-160
...
The Verification Validation Specialist performs verification & validation analysis, synthesising results
...
|---|---|---|
| Core verification & validation analysis (analytical) | Active (MVP) | Level 1 capability |
| Verification & Validation design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical verification & validation methods | Planned (V1) | Level 3 |
| Multi-physics verification & validation coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain verification & validation optimisation | Planned (V3) | Level 5 Master |
...
Every Verification Validation Specialist output MUST include:
...
6. `verification_&_validation_summary` — structured domain summary (see Output Contract)
...
confidence: 0.75
verification_&_validation_summary:
  method: "analytical"
  primary_result: 0.0
  units: "[specify]"
  safety_margin: 0.0
...
Raise **[VERIFICATION & VALIDATION SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core verification & validation analysis — analytical methods |
...
- **Regime violation**: applying verification & validation method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "Verification & Validation Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "verification_validation_specialist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for verification & validation
