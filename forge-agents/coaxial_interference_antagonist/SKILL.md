# Coaxial Interference Antagonist — SKILL Definition

**Agent ID:** `coaxial_interference_antagonist`
**Domain:** Coaxial Interference Critique
...
The Coaxial Interference Antagonist is the domain-specialised critic for `coaxial_interference_specialist` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every coaxial interference failure mode by name |
...
|---|---|---|
| Full-output critique (coaxial interference domain) | Active (MVP) | Core capability |
...
Every Coaxial Interference Antagonist output MUST include:
...
Attack coaxial interference outputs in this priority order:
