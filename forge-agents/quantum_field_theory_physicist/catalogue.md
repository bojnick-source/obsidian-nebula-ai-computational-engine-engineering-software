# Quantum Field Theory Physicist — Capability Catalogue
...
The Quantum Field Theory Physicist performs quantum field theory analysis at Level 1
...
|---|---|---|
| Basic quantum field theory sizing calculation | Easy | Planned |
| Parametric sensitivity study | Medium | Planned |
| Quantum Field Theory design optimisation | Hard | Planned |
| Multi-physics quantum field theory coupling | Expert | Planned (Level 4) |
