# Quantum Field Theory Physicist — SKILL Definition

**Agent ID:** `quantum_field_theory_physicist`
**Domain:** Quantum Field Theory — Gauge Theory, Feynman Diagrams, Renormalization
...
The Quantum Field Theory Physicist performs quantum field theory analysis, synthesising results
...
|---|---|---|
| Core quantum field theory analysis (analytical) | Active (MVP) | Level 1 capability |
| Quantum Field Theory design sizing | Active (Level 2) | Parametric methods |
| Sensitivity analysis | Planned (V1) | Level 3 |
| Numerical quantum field theory methods | Planned (V1) | Level 3 |
| Multi-physics quantum field theory coupling | Planned (V2) | Level 4 |
| Uncertainty quantification | Planned (V2) | Level 4 |
| Full-chain quantum field theory optimisation | Planned (V3) | Level 5 Master |
...
Every Quantum Field Theory Physicist output MUST include:
...
6. `quantum_field_theory_summary` — structured domain summary (see Output Contract)
...
Raise **[QUANTUM FIELD THEORY SIMULATION REQUIRED]** when:
...
|---|---|---|---|
| 1 | Novice | 0.00–0.39 | Core quantum field theory analysis — analytical methods |
...
- **Regime violation**: applying quantum field theory method outside its stated validity range without checking boundary conditions
...
paper_section_draft:
  ...
  subsection_title: "quantum field theory Analysis"
  content_latex: "..."
  equations_numbered: true
  notation_consistency: true

peer_review_verdict:
  target_agent_id: "quantum_field_theory_physicist"
  target_run_id: "..."
...
- Domain-specific standards and handbooks for quantum field theory
