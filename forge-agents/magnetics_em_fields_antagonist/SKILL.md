# Magnetics Em Fields Antagonist — SKILL Definition

**Agent ID:** `magnetics_em_fields_antagonist`
**Domain:** Magnetics & EM Fields Critique
...
The Magnetics Em Fields Antagonist is the domain-specialised critic for `magnetics_em_fields_specialist` outputs.
...
| Attribute | Setting |
|---|---|
| Domain knowledge | Deep — knows every magnetics & em fields failure mode by name |
...
|---|---|---|
| Full-output critique (magnetics & em fields domain) | Active (MVP) | Core capability |
...
Every Magnetics Em Fields Antagonist output MUST include:
...
Attack magnetics & em fields outputs in this priority order:
